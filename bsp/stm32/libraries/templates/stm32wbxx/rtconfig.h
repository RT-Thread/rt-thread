...
#define PKG_USING_STM32WB_HAL_DRIVER
#define PKG_USING_STM32WB_HAL_DRIVER_LATEST_VERSION
#define PKG_USING_STM32WB_CMSIS_DRIVER
#define PKG_USING_STM32WB_CMSIS_DRIVER_LATEST_VERSION
