# N32G457QEL-STB BSP 说明

## 简介

N32G457QEL-STB 是国民技术推出的一款N32G457系列的评估板，其搭载的MCU主要资源参数如下：
...
N32G457QEL-STB 板级包支持MDK5开发环境和GCC编译器，以下是具体版本信息：
...
- MCU：N32G457QEL7，主频 144MHz，512KB FLASH
- 常用外设
  - LED ：2个，D6（PB10），D17（PB15）
  - 按键：5个，RESET(NRST)，WAKEUP（PA0），S4（PC6），S5（PC7），S6（PB6）
...
下载程序成功之后，系统会自动运行，观察开发板上 LED 的运行效果，D17 会周期性闪烁。
