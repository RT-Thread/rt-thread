...
**
******************************************************************************/
#ifndef _GH_VO_MIXER1_H
#define _GH_VO_MIXER1_H
...
#define GH_VO_MIXER1_ENABLE_DEBUG_PRINT   0
#ifdef __LINUX__
#define GH_VO_MIXER1_DEBUG_PRINT_FUNCTION printk
#else
#define GH_VO_MIXER1_DEBUG_PRINT_FUNCTION printf
#endif
#ifndef __LINUX__
...
/* registers                                                                  */
/*----------------------------------------------------------------------------*/
#define REG_VO_MIXER1_CONTROL                               FIO_ADDRESS(VO_MIXER1,0x90004500) /* read/write */
#define REG_VO_MIXER1_STATUS                                FIO_ADDRESS(VO_MIXER1,0x90004504) /* read */
#define REG_VO_MIXER1_ACTIVE_SIZE                           FIO_ADDRESS(VO_MIXER1,0x90004508) /* read/write */
#define REG_VO_MIXER1_VIDEO_START                           FIO_ADDRESS(VO_MIXER1,0x9000450C) /* read/write */
#define REG_VO_MIXER1_VIDEO_END                             FIO_ADDRESS(VO_MIXER1,0x90004510) /* read/write */
#define REG_VO_MIXER1_OSD_START                             FIO_ADDRESS(VO_MIXER1,0x9000451C) /* read/write */
#define REG_VO_MIXER1_OSD_END                               FIO_ADDRESS(VO_MIXER1,0x90004520) /* read/write */
#define REG_VO_MIXER1_BACKGROUND                            FIO_ADDRESS(VO_MIXER1,0x90004524) /* read/write */
#define REG_VO_MIXER1_HIGHLIGHT                             FIO_ADDRESS(VO_MIXER1,0x90004528) /* read/write */
#define REG_VO_MIXER1_OSD_CONTROL                           FIO_ADDRESS(VO_MIXER1,0x9000452C) /* read/write */
#define REG_VO_MIXER1_ENABLE_CTRL                           FIO_ADDRESS(VO_MIXER1,0x90004550) /* read/write */
#define REG_VO_MIXER1_INPUT_VIDEO_SYNC                      FIO_ADDRESS(VO_MIXER1,0x90004554) /* read/write */
#define REG_VO_MIXER1_OUTPUT_SYNC                           FIO_ADDRESS(VO_MIXER1,0x9000455C) /* read/write */
#define REG_VO_MIXER1_SMEM_INPUT                            FIO_ADDRESS(VO_MIXER1,0x90004560) /* read/write */
#define REG_VO_MIXER1_SMEM_OUT                              FIO_ADDRESS(VO_MIXER1,0x90004568) /* read/write */
#define REG_VO_MIXER1_FRAME_ENABLE                          FIO_ADDRESS(VO_MIXER1,0x9000456C) /* read/write */
#define REG_VO_MIXER1_CLUT_B                                FIO_ADDRESS(VO_MIXER1,0x90011400) /* read/write */

/*----------------------------------------------------------------------------*/
/* bit group structures                                                       */
/*----------------------------------------------------------------------------*/
typedef union { /* VO_MIXER1_CONTROL */
    U32 all;
    struct {
        U32                             : 31;
        U32 reset                       : 1;
    } bitc;
} GH_VO_MIXER1_CONTROL_S;

typedef union { /* VO_MIXER1_STATUS */
    U32 all;
    struct {
        U32                             : 31;
        U32 reset                       : 1;
    } bitc;
} GH_VO_MIXER1_STATUS_S;

typedef union { /* VO_MIXER1_ACTIVE_SIZE */
    U32 all;
    struct {
        U32 vertical                    : 14;
        U32                             : 2;
...
} GH_VO_MIXER1_ACTIVE_SIZE_S;

typedef union { /* VO_MIXER1_VIDEO_START */
    U32 all;
    struct {
        U32 vertical                    : 14;
        U32                             : 2;
...
} GH_VO_MIXER1_VIDEO_START_S;

typedef union { /* VO_MIXER1_VIDEO_END */
    U32 all;
    struct {
        U32 vertical                    : 14;
        U32                             : 2;
...
} GH_VO_MIXER1_VIDEO_END_S;

typedef union { /* VO_MIXER1_OSD_START */
    U32 all;
    struct {
        U32 vertical                    : 14;
        U32                             : 2;
...
} GH_VO_MIXER1_OSD_START_S;

typedef union { /* VO_MIXER1_OSD_END */
    U32 all;
    struct {
        U32 vertical                    : 14;
        U32                             : 2;
...
} GH_VO_MIXER1_OSD_END_S;

typedef union { /* VO_MIXER1_BACKGROUND */
    U32 all;
    struct {
        U32 v                           : 8;
        U32 u                           : 8;
...
} GH_VO_MIXER1_BACKGROUND_S;

typedef union { /* VO_MIXER1_HIGHLIGHT */
    U32 all;
    struct {
        U32 v                           : 8;
        U32 u                           : 8;
...
} GH_VO_MIXER1_HIGHLIGHT_S;

typedef union { /* VO_MIXER1_OSD_CONTROL */
    U32 all;
    struct {
        U32 global_blend                : 8;
        U32 premultiplied               : 1;
...
} GH_VO_MIXER1_OSD_CONTROL_S;

typedef union { /* VO_MIXER1_ENABLE_CTRL */
    U32 all;
    struct {
        U32 enable                      : 1;
        U32 mapped_direct               : 2;
...
} GH_VO_MIXER1_ENABLE_CTRL_S;

typedef union { /* VO_MIXER1_INPUT_VIDEO_SYNC */
    U32 all;
    struct {
        U32 sync_mode                   : 2;
        U32 line                        : 3;
...
} GH_VO_MIXER1_INPUT_VIDEO_SYNC_S;

typedef union { /* VO_MIXER1_OUTPUT_SYNC */
    U32 all;
    struct {
        U32 sync_mode                   : 1;
        U32                             : 1;
...
} GH_VO_MIXER1_OUTPUT_SYNC_S;

typedef union { /* VO_MIXER1_SMEM_INPUT */
    U32 all;
    struct {
        U32 luma_number                 : 8;
        U32 chroma_number               : 8;
...
} GH_VO_MIXER1_SMEM_INPUT_S;

typedef union { /* VO_MIXER1_SMEM_OUT */
    U32 all;
    struct {
        U32 luma_number                 : 8;
        U32 chroma_number               : 8;
...
} GH_VO_MIXER1_SMEM_OUT_S;

typedef union { /* VO_MIXER1_FRAME_ENABLE */
    U32 all;
    struct {
        U32 enable                      : 1;
        U32                             : 31;
    } bitc;
} GH_VO_MIXER1_FRAME_ENABLE_S;
...
/*! \brief Writes the register 'VO_MIXER1_CONTROL'. */
void GH_VO_MIXER1_set_CONTROL(U32 data);
/*! \brief Reads the register 'VO_MIXER1_CONTROL'. */
U32  GH_VO_MIXER1_get_CONTROL(void);
/*! \brief Writes the bit group 'Reset' of register 'VO_MIXER1_CONTROL'. */
void GH_VO_MIXER1_set_CONTROL_Reset(U8 data);
/*! \brief Reads the bit group 'Reset' of register 'VO_MIXER1_CONTROL'. */
U8   GH_VO_MIXER1_get_CONTROL_Reset(void);
#else /* GH_INLINE_LEVEL == 0 */
GH_INLINE void GH_VO_MIXER1_set_CONTROL(U32 data)
{
...
GH_INLINE U32  GH_VO_MIXER1_get_CONTROL(void)
{
...
GH_INLINE void GH_VO_MIXER1_set_CONTROL_Reset(U8 data)
{
...
GH_INLINE U8   GH_VO_MIXER1_get_CONTROL_Reset(void)
{
...
/*----------------------------------------------------------------------------*/
#if GH_INLINE_LEVEL == 0
/*! \brief Reads the register 'VO_MIXER1_STATUS'. */
U32  GH_VO_MIXER1_get_STATUS(void);
/*! \brief Reads the bit group 'Reset' of register 'VO_MIXER1_STATUS'. */
U8   GH_VO_MIXER1_get_STATUS_Reset(void);
#else /* GH_INLINE_LEVEL == 0 */
GH_INLINE U32  GH_VO_MIXER1_get_STATUS(void)
{
...
GH_INLINE U8   GH_VO_MIXER1_get_STATUS_Reset(void)
{
...
/*----------------------------------------------------------------------------*/
#if GH_INLINE_LEVEL == 0
/*! \brief Writes the register 'VO_MIXER1_ACTIVE_SIZE'. */
void GH_VO_MIXER1_set_ACTIVE_SIZE(U32 data);
/*! \brief Reads the register 'VO_MIXER1_ACTIVE_SIZE'. */
U32  GH_VO_MIXER1_get_ACTIVE_SIZE(void);
/*! \brief Writes the bit group 'Vertical' of register 'VO_MIXER1_ACTIVE_SIZE'. */
void GH_VO_MIXER1_set_ACTIVE_SIZE_Vertical(U16 data);
/*! \brief Reads the bit group 'Vertical' of register 'VO_MIXER1_ACTIVE_SIZE'. */
U16  GH_VO_MIXER1_get_ACTIVE_SIZE_Vertical(void);
/*! \brief Writes the bit group 'Horizontal' of register 'VO_MIXER1_ACTIVE_SIZE'. */
void GH_VO_MIXER1_set_ACTIVE_SIZE_Horizontal(U16 data);
/*! \brief Reads the bit group 'Horizontal' of register 'VO_MIXER1_ACTIVE_SIZE'. */
U16  GH_VO_MIXER1_get_ACTIVE_SIZE_Horizontal(void);
#else /* GH_INLINE_LEVEL == 0 */
GH_INLINE void GH_VO_MIXER1_set_ACTIVE_SIZE(U32 data)
{
...
GH_INLINE U32  GH_VO_MIXER1_get_ACTIVE_SIZE(void)
{
...
GH_INLINE void GH_VO_MIXER1_set_ACTIVE_SIZE_Vertical(U16 data)
{
...
GH_INLINE U16  GH_VO_MIXER1_get_ACTIVE_SIZE_Vertical(void)
{
...
GH_INLINE void GH_VO_MIXER1_set_ACTIVE_SIZE_Horizontal(U16 data)
{
    GH_VO_MIXER1_ACTIVE_SIZE_S d;
    d.all = *(volatile U32 *)REG_VO_MIXER1_ACTIVE_SIZE;
...
GH_INLINE U16  GH_VO_MIXER1_get_ACTIVE_SIZE_Horizontal(void)
{
    GH_VO_MIXER1_ACTIVE_SIZE_S tmp_value;
    U32 value = (*(volatile U32 *)REG_VO_MIXER1_ACTIVE_SIZE);
...
/*----------------------------------------------------------------------------*/
#if GH_INLINE_LEVEL == 0
/*! \brief Writes the register 'VO_MIXER1_VIDEO_START'. */
void GH_VO_MIXER1_set_VIDEO_START(U32 data);
/*! \brief Reads the register 'VO_MIXER1_VIDEO_START'. */
U32  GH_VO_MIXER1_get_VIDEO_START(void);
/*! \brief Writes the bit group 'Vertical' of register 'VO_MIXER1_VIDEO_START'. */
void GH_VO_MIXER1_set_VIDEO_START_Vertical(U16 data);
/*! \brief Reads the bit group 'Vertical' of register 'VO_MIXER1_VIDEO_START'. */
U16  GH_VO_MIXER1_get_VIDEO_START_Vertical(void);
/*! \brief Writes the bit group 'Horizontal' of register 'VO_MIXER1_VIDEO_START'. */
void GH_VO_MIXER1_set_VIDEO_START_Horizontal(U16 data);
/*! \brief Reads the bit group 'Horizontal' of register 'VO_MIXER1_VIDEO_START'. */
U16  GH_VO_MIXER1_get_VIDEO_START_Horizontal(void);
#else /* GH_INLINE_LEVEL == 0 */
GH_INLINE void GH_VO_MIXER1_set_VIDEO_START(U32 data)
{
...
GH_INLINE U32  GH_VO_MIXER1_get_VIDEO_START(void)
{
...
GH_INLINE void GH_VO_MIXER1_set_VIDEO_START_Vertical(U16 data)
{
...
GH_INLINE U16  GH_VO_MIXER1_get_VIDEO_START_Vertical(void)
{
...
GH_INLINE void GH_VO_MIXER1_set_VIDEO_START_Horizontal(U16 data)
{
    GH_VO_MIXER1_VIDEO_START_S d;
    d.all = *(volatile U32 *)REG_VO_MIXER1_VIDEO_START;
    d.bitc.horizontal = data;
...
GH_INLINE U16  GH_VO_MIXER1_get_VIDEO_START_Horizontal(void)
{
    GH_VO_MIXER1_VIDEO_START_S tmp_value;
    U32 value = (*(volatile U32 *)REG_VO_MIXER1_VIDEO_START);
...
/*----------------------------------------------------------------------------*/
#if GH_INLINE_LEVEL == 0
/*! \brief Writes the register 'VO_MIXER1_VIDEO_END'. */
void GH_VO_MIXER1_set_VIDEO_END(U32 data);
/*! \brief Reads the register 'VO_MIXER1_VIDEO_END'. */
U32  GH_VO_MIXER1_get_VIDEO_END(void);
/*! \brief Writes the bit group 'Vertical' of register 'VO_MIXER1_VIDEO_END'. */
void GH_VO_MIXER1_set_VIDEO_END_Vertical(U16 data);
/*! \brief Reads the bit group 'Vertical' of register 'VO_MIXER1_VIDEO_END'. */
U16  GH_VO_MIXER1_get_VIDEO_END_Vertical(void);
/*! \brief Writes the bit group 'Horizontal' of register 'VO_MIXER1_VIDEO_END'. */
void GH_VO_MIXER1_set_VIDEO_END_Horizontal(U16 data);
/*! \brief Reads the bit group 'Horizontal' of register 'VO_MIXER1_VIDEO_END'. */
U16  GH_VO_MIXER1_get_VIDEO_END_Horizontal(void);
#else /* GH_INLINE_LEVEL == 0 */
GH_INLINE void GH_VO_MIXER1_set_VIDEO_END(U32 data)
{
...
GH_INLINE U32  GH_VO_MIXER1_get_VIDEO_END(void)
{
...
GH_INLINE void GH_VO_MIXER1_set_VIDEO_END_Vertical(U16 data)
{
...
GH_INLINE U16  GH_VO_MIXER1_get_VIDEO_END_Vertical(void)
{
...
GH_INLINE void GH_VO_MIXER1_set_VIDEO_END_Horizontal(U16 data)
{
    GH_VO_MIXER1_VIDEO_END_S d;
    d.all = *(volatile U32 *)REG_VO_MIXER1_VIDEO_END;
    d.bitc.horizontal = data;
...
GH_INLINE U16  GH_VO_MIXER1_get_VIDEO_END_Horizontal(void)
{
    GH_VO_MIXER1_VIDEO_END_S tmp_value;
    U32 value = (*(volatile U32 *)REG_VO_MIXER1_VIDEO_END);
...
/*----------------------------------------------------------------------------*/
#if GH_INLINE_LEVEL == 0
/*! \brief Writes the register 'VO_MIXER1_OSD_START'. */
void GH_VO_MIXER1_set_OSD_START(U32 data);
/*! \brief Reads the register 'VO_MIXER1_OSD_START'. */
U32  GH_VO_MIXER1_get_OSD_START(void);
/*! \brief Writes the bit group 'Vertical' of register 'VO_MIXER1_OSD_START'. */
void GH_VO_MIXER1_set_OSD_START_Vertical(U16 data);
/*! \brief Reads the bit group 'Vertical' of register 'VO_MIXER1_OSD_START'. */
U16  GH_VO_MIXER1_get_OSD_START_Vertical(void);
/*! \brief Writes the bit group 'Horizontal' of register 'VO_MIXER1_OSD_START'. */
void GH_VO_MIXER1_set_OSD_START_Horizontal(U16 data);
/*! \brief Reads the bit group 'Horizontal' of register 'VO_MIXER1_OSD_START'. */
U16  GH_VO_MIXER1_get_OSD_START_Horizontal(void);
#else /* GH_INLINE_LEVEL == 0 */
GH_INLINE void GH_VO_MIXER1_set_OSD_START(U32 data)
{
...
GH_INLINE U32  GH_VO_MIXER1_get_OSD_START(void)
{
...
GH_INLINE void GH_VO_MIXER1_set_OSD_START_Vertical(U16 data)
{
...
GH_INLINE U16  GH_VO_MIXER1_get_OSD_START_Vertical(void)
{
...
GH_INLINE void GH_VO_MIXER1_set_OSD_START_Horizontal(U16 data)
{
    GH_VO_MIXER1_OSD_START_S d;
    d.all = *(volatile U32 *)REG_VO_MIXER1_OSD_START;
    d.bitc.horizontal = data;
...
GH_INLINE U16  GH_VO_MIXER1_get_OSD_START_Horizontal(void)
{
    GH_VO_MIXER1_OSD_START_S tmp_value;
    U32 value = (*(volatile U32 *)REG_VO_MIXER1_OSD_START);
...
/*----------------------------------------------------------------------------*/
#if GH_INLINE_LEVEL == 0
/*! \brief Writes the register 'VO_MIXER1_OSD_END'. */
void GH_VO_MIXER1_set_OSD_END(U32 data);
/*! \brief Reads the register 'VO_MIXER1_OSD_END'. */
U32  GH_VO_MIXER1_get_OSD_END(void);
/*! \brief Writes the bit group 'Vertical' of register 'VO_MIXER1_OSD_END'. */
void GH_VO_MIXER1_set_OSD_END_Vertical(U16 data);
/*! \brief Reads the bit group 'Vertical' of register 'VO_MIXER1_OSD_END'. */
U16  GH_VO_MIXER1_get_OSD_END_Vertical(void);
/*! \brief Writes the bit group 'Horizontal' of register 'VO_MIXER1_OSD_END'. */
void GH_VO_MIXER1_set_OSD_END_Horizontal(U16 data);
/*! \brief Reads the bit group 'Horizontal' of register 'VO_MIXER1_OSD_END'. */
U16  GH_VO_MIXER1_get_OSD_END_Horizontal(void);
#else /* GH_INLINE_LEVEL == 0 */
GH_INLINE void GH_VO_MIXER1_set_OSD_END(U32 data)
{
...
GH_INLINE U32  GH_VO_MIXER1_get_OSD_END(void)
{
...
GH_INLINE void GH_VO_MIXER1_set_OSD_END_Vertical(U16 data)
{
...
GH_INLINE U16  GH_VO_MIXER1_get_OSD_END_Vertical(void)
{
...
GH_INLINE void GH_VO_MIXER1_set_OSD_END_Horizontal(U16 data)
{
    GH_VO_MIXER1_OSD_END_S d;
    d.all = *(volatile U32 *)REG_VO_MIXER1_OSD_END;
    d.bitc.horizontal = data;
...
GH_INLINE U16  GH_VO_MIXER1_get_OSD_END_Horizontal(void)
{
    GH_VO_MIXER1_OSD_END_S tmp_value;
    U32 value = (*(volatile U32 *)REG_VO_MIXER1_OSD_END);
...
/*----------------------------------------------------------------------------*/
#if GH_INLINE_LEVEL == 0
/*! \brief Writes the register 'VO_MIXER1_BACKGROUND'. */
void GH_VO_MIXER1_set_BACKGROUND(U32 data);
/*! \brief Reads the register 'VO_MIXER1_BACKGROUND'. */
U32  GH_VO_MIXER1_get_BACKGROUND(void);
/*! \brief Writes the bit group 'V' of register 'VO_MIXER1_BACKGROUND'. */
void GH_VO_MIXER1_set_BACKGROUND_V(U8 data);
/*! \brief Reads the bit group 'V' of register 'VO_MIXER1_BACKGROUND'. */
U8   GH_VO_MIXER1_get_BACKGROUND_V(void);
/*! \brief Writes the bit group 'U' of register 'VO_MIXER1_BACKGROUND'. */
void GH_VO_MIXER1_set_BACKGROUND_U(U8 data);
/*! \brief Reads the bit group 'U' of register 'VO_MIXER1_BACKGROUND'. */
U8   GH_VO_MIXER1_get_BACKGROUND_U(void);
/*! \brief Writes the bit group 'Y' of register 'VO_MIXER1_BACKGROUND'. */
void GH_VO_MIXER1_set_BACKGROUND_Y(U8 data);
/*! \brief Reads the bit group 'Y' of register 'VO_MIXER1_BACKGROUND'. */
U8   GH_VO_MIXER1_get_BACKGROUND_Y(void);
#else /* GH_INLINE_LEVEL == 0 */
GH_INLINE void GH_VO_MIXER1_set_BACKGROUND(U32 data)
{
...
GH_INLINE U32  GH_VO_MIXER1_get_BACKGROUND(void)
{
...
GH_INLINE void GH_VO_MIXER1_set_BACKGROUND_V(U8 data)
{
...
GH_INLINE U8   GH_VO_MIXER1_get_BACKGROUND_V(void)
{
...
GH_INLINE void GH_VO_MIXER1_set_BACKGROUND_U(U8 data)
{
    GH_VO_MIXER1_BACKGROUND_S d;
    d.all = *(volatile U32 *)REG_VO_MIXER1_BACKGROUND;
    d.bitc.u = data;
...
GH_INLINE U8   GH_VO_MIXER1_get_BACKGROUND_U(void)
{
    GH_VO_MIXER1_BACKGROUND_S tmp_value;
    U32 value = (*(volatile U32 *)REG_VO_MIXER1_BACKGROUND);
...
GH_INLINE void GH_VO_MIXER1_set_BACKGROUND_Y(U8 data)
{
    GH_VO_MIXER1_BACKGROUND_S d;
    d.all = *(volatile U32 *)REG_VO_MIXER1_BACKGROUND;
    d.bitc.y = data;
...
GH_INLINE U8   GH_VO_MIXER1_get_BACKGROUND_Y(void)
{
    GH_VO_MIXER1_BACKGROUND_S tmp_value;
    U32 value = (*(volatile U32 *)REG_VO_MIXER1_BACKGROUND);
...
/*----------------------------------------------------------------------------*/
#if GH_INLINE_LEVEL == 0
/*! \brief Writes the register 'VO_MIXER1_HIGHLIGHT'. */
void GH_VO_MIXER1_set_HIGHLIGHT(U32 data);
/*! \brief Reads the register 'VO_MIXER1_HIGHLIGHT'. */
U32  GH_VO_MIXER1_get_HIGHLIGHT(void);
/*! \brief Writes the bit group 'V' of register 'VO_MIXER1_HIGHLIGHT'. */
void GH_VO_MIXER1_set_HIGHLIGHT_V(U8 data);
/*! \brief Reads the bit group 'V' of register 'VO_MIXER1_HIGHLIGHT'. */
U8   GH_VO_MIXER1_get_HIGHLIGHT_V(void);
/*! \brief Writes the bit group 'U' of register 'VO_MIXER1_HIGHLIGHT'. */
void GH_VO_MIXER1_set_HIGHLIGHT_U(U8 data);
/*! \brief Reads the bit group 'U' of register 'VO_MIXER1_HIGHLIGHT'. */
U8   GH_VO_MIXER1_get_HIGHLIGHT_U(void);
/*! \brief Writes the bit group 'Y' of register 'VO_MIXER1_HIGHLIGHT'. */
void GH_VO_MIXER1_set_HIGHLIGHT_Y(U8 data);
/*! \brief Reads the bit group 'Y' of register 'VO_MIXER1_HIGHLIGHT'. */
U8   GH_VO_MIXER1_get_HIGHLIGHT_Y(void);
/*! \brief Writes the bit group 'threshold' of register 'VO_MIXER1_HIGHLIGHT'. */
void GH_VO_MIXER1_set_HIGHLIGHT_threshold(U8 data);
/*! \brief Reads the bit group 'threshold' of register 'VO_MIXER1_HIGHLIGHT'. */
U8   GH_VO_MIXER1_get_HIGHLIGHT_threshold(void);
#else /* GH_INLINE_LEVEL == 0 */
GH_INLINE void GH_VO_MIXER1_set_HIGHLIGHT(U32 data)
{
...
GH_INLINE U32  GH_VO_MIXER1_get_HIGHLIGHT(void)
{
...
GH_INLINE void GH_VO_MIXER1_set_HIGHLIGHT_V(U8 data)
{
...
GH_INLINE U8   GH_VO_MIXER1_get_HIGHLIGHT_V(void)
{
...
GH_INLINE void GH_VO_MIXER1_set_HIGHLIGHT_U(U8 data)
{
    GH_VO_MIXER1_HIGHLIGHT_S d;
    d.all = *(volatile U32 *)REG_VO_MIXER1_HIGHLIGHT;
    d.bitc.u = data;
...
GH_INLINE U8   GH_VO_MIXER1_get_HIGHLIGHT_U(void)
{
    GH_VO_MIXER1_HIGHLIGHT_S tmp_value;
    U32 value = (*(volatile U32 *)REG_VO_MIXER1_HIGHLIGHT);
...
GH_INLINE void GH_VO_MIXER1_set_HIGHLIGHT_Y(U8 data)
{
    GH_VO_MIXER1_HIGHLIGHT_S d;
    d.all = *(volatile U32 *)REG_VO_MIXER1_HIGHLIGHT;
    d.bitc.y = data;
...
GH_INLINE U8   GH_VO_MIXER1_get_HIGHLIGHT_Y(void)
{
    GH_VO_MIXER1_HIGHLIGHT_S tmp_value;
    U32 value = (*(volatile U32 *)REG_VO_MIXER1_HIGHLIGHT);
...
GH_INLINE void GH_VO_MIXER1_set_HIGHLIGHT_threshold(U8 data)
{
    GH_VO_MIXER1_HIGHLIGHT_S d;
    d.all = *(volatile U32 *)REG_VO_MIXER1_HIGHLIGHT;
...
GH_INLINE U8   GH_VO_MIXER1_get_HIGHLIGHT_threshold(void)
{
    GH_VO_MIXER1_HIGHLIGHT_S tmp_value;
    U32 value = (*(volatile U32 *)REG_VO_MIXER1_HIGHLIGHT);
...
/*----------------------------------------------------------------------------*/
#if GH_INLINE_LEVEL == 0
/*! \brief Writes the register 'VO_MIXER1_OSD_CONTROL'. */
void GH_VO_MIXER1_set_OSD_CONTROL(U32 data);
/*! \brief Reads the register 'VO_MIXER1_OSD_CONTROL'. */
U32  GH_VO_MIXER1_get_OSD_CONTROL(void);
/*! \brief Writes the bit group 'Global_Blend' of register 'VO_MIXER1_OSD_CONTROL'. */
void GH_VO_MIXER1_set_OSD_CONTROL_Global_Blend(U8 data);
/*! \brief Reads the bit group 'Global_Blend' of register 'VO_MIXER1_OSD_CONTROL'. */
U8   GH_VO_MIXER1_get_OSD_CONTROL_Global_Blend(void);
/*! \brief Writes the bit group 'Premultiplied' of register 'VO_MIXER1_OSD_CONTROL'. */
void GH_VO_MIXER1_set_OSD_CONTROL_Premultiplied(U8 data);
/*! \brief Reads the bit group 'Premultiplied' of register 'VO_MIXER1_OSD_CONTROL'. */
U8   GH_VO_MIXER1_get_OSD_CONTROL_Premultiplied(void);
/*! \brief Writes the bit group 'Mode' of register 'VO_MIXER1_OSD_CONTROL'. */
void GH_VO_MIXER1_set_OSD_CONTROL_Mode(U8 data);
/*! \brief Reads the bit group 'Mode' of register 'VO_MIXER1_OSD_CONTROL'. */
U8   GH_VO_MIXER1_get_OSD_CONTROL_Mode(void);
/*! \brief Writes the bit group 'Enable_Transparent_Color' of register 'VO_MIXER1_OSD_CONTROL'. */
void GH_VO_MIXER1_set_OSD_CONTROL_Enable_Transparent_Color(U8 data);
/*! \brief Reads the bit group 'Enable_Transparent_Color' of register 'VO_MIXER1_OSD_CONTROL'. */
U8   GH_VO_MIXER1_get_OSD_CONTROL_Enable_Transparent_Color(void);
/*! \brief Writes the bit group 'Transparent_Color' of register 'VO_MIXER1_OSD_CONTROL'. */
void GH_VO_MIXER1_set_OSD_CONTROL_Transparent_Color(U16 data);
/*! \brief Reads the bit group 'Transparent_Color' of register 'VO_MIXER1_OSD_CONTROL'. */
U16  GH_VO_MIXER1_get_OSD_CONTROL_Transparent_Color(void);
#else /* GH_INLINE_LEVEL == 0 */
GH_INLINE void GH_VO_MIXER1_set_OSD_CONTROL(U32 data)
{
...
GH_INLINE U32  GH_VO_MIXER1_get_OSD_CONTROL(void)
{
...
GH_INLINE void GH_VO_MIXER1_set_OSD_CONTROL_Global_Blend(U8 data)
{
...
GH_INLINE U8   GH_VO_MIXER1_get_OSD_CONTROL_Global_Blend(void)
{
...
GH_INLINE void GH_VO_MIXER1_set_OSD_CONTROL_Premultiplied(U8 data)
{
    GH_VO_MIXER1_OSD_CONTROL_S d;
    d.all = *(volatile U32 *)REG_VO_MIXER1_OSD_CONTROL;
...
GH_INLINE U8   GH_VO_MIXER1_get_OSD_CONTROL_Premultiplied(void)
{
    GH_VO_MIXER1_OSD_CONTROL_S tmp_value;
    U32 value = (*(volatile U32 *)REG_VO_MIXER1_OSD_CONTROL);
...
GH_INLINE void GH_VO_MIXER1_set_OSD_CONTROL_Mode(U8 data)
{
    GH_VO_MIXER1_OSD_CONTROL_S d;
    d.all = *(volatile U32 *)REG_VO_MIXER1_OSD_CONTROL;
    d.bitc.mode = data;
...
GH_INLINE U8   GH_VO_MIXER1_get_OSD_CONTROL_Mode(void)
{
    GH_VO_MIXER1_OSD_CONTROL_S tmp_value;
    U32 value = (*(volatile U32 *)REG_VO_MIXER1_OSD_CONTROL);
...
GH_INLINE void GH_VO_MIXER1_set_OSD_CONTROL_Enable_Transparent_Color(U8 data)
{
    GH_VO_MIXER1_OSD_CONTROL_S d;
    d.all = *(volatile U32 *)REG_VO_MIXER1_OSD_CONTROL;
...
GH_INLINE U8   GH_VO_MIXER1_get_OSD_CONTROL_Enable_Transparent_Color(void)
{
    GH_VO_MIXER1_OSD_CONTROL_S tmp_value;
    U32 value = (*(volatile U32 *)REG_VO_MIXER1_OSD_CONTROL);
...
GH_INLINE void GH_VO_MIXER1_set_OSD_CONTROL_Transparent_Color(U16 data)
{
    GH_VO_MIXER1_OSD_CONTROL_S d;
    d.all = *(volatile U32 *)REG_VO_MIXER1_OSD_CONTROL;
...
GH_INLINE U16  GH_VO_MIXER1_get_OSD_CONTROL_Transparent_Color(void)
{
    GH_VO_MIXER1_OSD_CONTROL_S tmp_value;
    U32 value = (*(volatile U32 *)REG_VO_MIXER1_OSD_CONTROL);
...
/*----------------------------------------------------------------------------*/
#if GH_INLINE_LEVEL == 0
/*! \brief Writes the register 'VO_MIXER1_ENABLE_CTRL'. */
void GH_VO_MIXER1_set_ENABLE_CTRL(U32 data);
/*! \brief Reads the register 'VO_MIXER1_ENABLE_CTRL'. */
U32  GH_VO_MIXER1_get_ENABLE_CTRL(void);
/*! \brief Writes the bit group 'enable' of register 'VO_MIXER1_ENABLE_CTRL'. */
void GH_VO_MIXER1_set_ENABLE_CTRL_enable(U8 data);
/*! \brief Reads the bit group 'enable' of register 'VO_MIXER1_ENABLE_CTRL'. */
U8   GH_VO_MIXER1_get_ENABLE_CTRL_enable(void);
/*! \brief Writes the bit group 'mapped_direct' of register 'VO_MIXER1_ENABLE_CTRL'. */
void GH_VO_MIXER1_set_ENABLE_CTRL_mapped_direct(U8 data);
/*! \brief Reads the bit group 'mapped_direct' of register 'VO_MIXER1_ENABLE_CTRL'. */
U8   GH_VO_MIXER1_get_ENABLE_CTRL_mapped_direct(void);
/*! \brief Writes the bit group 'smem' of register 'VO_MIXER1_ENABLE_CTRL'. */
void GH_VO_MIXER1_set_ENABLE_CTRL_smem(U8 data);
/*! \brief Reads the bit group 'smem' of register 'VO_MIXER1_ENABLE_CTRL'. */
U8   GH_VO_MIXER1_get_ENABLE_CTRL_smem(void);
/*! \brief Writes the bit group 'display' of register 'VO_MIXER1_ENABLE_CTRL'. */
void GH_VO_MIXER1_set_ENABLE_CTRL_display(U8 data);
/*! \brief Reads the bit group 'display' of register 'VO_MIXER1_ENABLE_CTRL'. */
U8   GH_VO_MIXER1_get_ENABLE_CTRL_display(void);
#else /* GH_INLINE_LEVEL == 0 */
GH_INLINE void GH_VO_MIXER1_set_ENABLE_CTRL(U32 data)
{
...
GH_INLINE U32  GH_VO_MIXER1_get_ENABLE_CTRL(void)
{
...
GH_INLINE void GH_VO_MIXER1_set_ENABLE_CTRL_enable(U8 data)
{
...
GH_INLINE U8   GH_VO_MIXER1_get_ENABLE_CTRL_enable(void)
{
...
GH_INLINE void GH_VO_MIXER1_set_ENABLE_CTRL_mapped_direct(U8 data)
{
    GH_VO_MIXER1_ENABLE_CTRL_S d;
    d.all = *(volatile U32 *)REG_VO_MIXER1_ENABLE_CTRL;
...
GH_INLINE U8   GH_VO_MIXER1_get_ENABLE_CTRL_mapped_direct(void)
{
    GH_VO_MIXER1_ENABLE_CTRL_S tmp_value;
    U32 value = (*(volatile U32 *)REG_VO_MIXER1_ENABLE_CTRL);
...
GH_INLINE void GH_VO_MIXER1_set_ENABLE_CTRL_smem(U8 data)
{
    GH_VO_MIXER1_ENABLE_CTRL_S d;
    d.all = *(volatile U32 *)REG_VO_MIXER1_ENABLE_CTRL;
    d.bitc.smem = data;
...
GH_INLINE U8   GH_VO_MIXER1_get_ENABLE_CTRL_smem(void)
{
    GH_VO_MIXER1_ENABLE_CTRL_S tmp_value;
    U32 value = (*(volatile U32 *)REG_VO_MIXER1_ENABLE_CTRL);
...
GH_INLINE void GH_VO_MIXER1_set_ENABLE_CTRL_display(U8 data)
{
    GH_VO_MIXER1_ENABLE_CTRL_S d;
    d.all = *(volatile U32 *)REG_VO_MIXER1_ENABLE_CTRL;
    d.bitc.display = data;
...
GH_INLINE U8   GH_VO_MIXER1_get_ENABLE_CTRL_display(void)
{
    GH_VO_MIXER1_ENABLE_CTRL_S tmp_value;
    U32 value = (*(volatile U32 *)REG_VO_MIXER1_ENABLE_CTRL);
...
/*----------------------------------------------------------------------------*/
#if GH_INLINE_LEVEL == 0
/*! \brief Writes the register 'VO_MIXER1_INPUT_VIDEO_SYNC'. */
void GH_VO_MIXER1_set_INPUT_VIDEO_SYNC(U32 data);
/*! \brief Reads the register 'VO_MIXER1_INPUT_VIDEO_SYNC'. */
U32  GH_VO_MIXER1_get_INPUT_VIDEO_SYNC(void);
/*! \brief Writes the bit group 'sync_mode' of register 'VO_MIXER1_INPUT_VIDEO_SYNC'. */
void GH_VO_MIXER1_set_INPUT_VIDEO_SYNC_sync_mode(U8 data);
/*! \brief Reads the bit group 'sync_mode' of register 'VO_MIXER1_INPUT_VIDEO_SYNC'. */
U8   GH_VO_MIXER1_get_INPUT_VIDEO_SYNC_sync_mode(void);
/*! \brief Writes the bit group 'line' of register 'VO_MIXER1_INPUT_VIDEO_SYNC'. */
void GH_VO_MIXER1_set_INPUT_VIDEO_SYNC_line(U8 data);
/*! \brief Reads the bit group 'line' of register 'VO_MIXER1_INPUT_VIDEO_SYNC'. */
U8   GH_VO_MIXER1_get_INPUT_VIDEO_SYNC_line(void);
/*! \brief Writes the bit group 'video' of register 'VO_MIXER1_INPUT_VIDEO_SYNC'. */
void GH_VO_MIXER1_set_INPUT_VIDEO_SYNC_video(U8 data);
/*! \brief Reads the bit group 'video' of register 'VO_MIXER1_INPUT_VIDEO_SYNC'. */
U8   GH_VO_MIXER1_get_INPUT_VIDEO_SYNC_video(void);
/*! \brief Writes the bit group 'decrement' of register 'VO_MIXER1_INPUT_VIDEO_SYNC'. */
void GH_VO_MIXER1_set_INPUT_VIDEO_SYNC_decrement(U8 data);
/*! \brief Reads the bit group 'decrement' of register 'VO_MIXER1_INPUT_VIDEO_SYNC'. */
U8   GH_VO_MIXER1_get_INPUT_VIDEO_SYNC_decrement(void);
#else /* GH_INLINE_LEVEL == 0 */
GH_INLINE void GH_VO_MIXER1_set_INPUT_VIDEO_SYNC(U32 data)
{
...
GH_INLINE U32  GH_VO_MIXER1_get_INPUT_VIDEO_SYNC(void)
{
...
GH_INLINE void GH_VO_MIXER1_set_INPUT_VIDEO_SYNC_sync_mode(U8 data)
{
...
GH_INLINE U8   GH_VO_MIXER1_get_INPUT_VIDEO_SYNC_sync_mode(void)
{
...
GH_INLINE void GH_VO_MIXER1_set_INPUT_VIDEO_SYNC_line(U8 data)
{
    GH_VO_MIXER1_INPUT_VIDEO_SYNC_S d;
    d.all = *(volatile U32 *)REG_VO_MIXER1_INPUT_VIDEO_SYNC;
    d.bitc.line = data;
...
GH_INLINE U8   GH_VO_MIXER1_get_INPUT_VIDEO_SYNC_line(void)
{
    GH_VO_MIXER1_INPUT_VIDEO_SYNC_S tmp_value;
    U32 value = (*(volatile U32 *)REG_VO_MIXER1_INPUT_VIDEO_SYNC);
...
GH_INLINE void GH_VO_MIXER1_set_INPUT_VIDEO_SYNC_video(U8 data)
{
    GH_VO_MIXER1_INPUT_VIDEO_SYNC_S d;
    d.all = *(volatile U32 *)REG_VO_MIXER1_INPUT_VIDEO_SYNC;
    d.bitc.video = data;
...
GH_INLINE U8   GH_VO_MIXER1_get_INPUT_VIDEO_SYNC_video(void)
{
    GH_VO_MIXER1_INPUT_VIDEO_SYNC_S tmp_value;
    U32 value = (*(volatile U32 *)REG_VO_MIXER1_INPUT_VIDEO_SYNC);
...
GH_INLINE void GH_VO_MIXER1_set_INPUT_VIDEO_SYNC_decrement(U8 data)
{
    GH_VO_MIXER1_INPUT_VIDEO_SYNC_S d;
    d.all = *(volatile U32 *)REG_VO_MIXER1_INPUT_VIDEO_SYNC;
...
GH_INLINE U8   GH_VO_MIXER1_get_INPUT_VIDEO_SYNC_decrement(void)
{
    GH_VO_MIXER1_INPUT_VIDEO_SYNC_S tmp_value;
    U32 value = (*(volatile U32 *)REG_VO_MIXER1_INPUT_VIDEO_SYNC);
...
/*----------------------------------------------------------------------------*/
#if GH_INLINE_LEVEL == 0
/*! \brief Writes the register 'VO_MIXER1_OUTPUT_SYNC'. */
void GH_VO_MIXER1_set_OUTPUT_SYNC(U32 data);
/*! \brief Reads the register 'VO_MIXER1_OUTPUT_SYNC'. */
U32  GH_VO_MIXER1_get_OUTPUT_SYNC(void);
/*! \brief Writes the bit group 'sync_mode' of register 'VO_MIXER1_OUTPUT_SYNC'. */
void GH_VO_MIXER1_set_OUTPUT_SYNC_sync_mode(U8 data);
/*! \brief Reads the bit group 'sync_mode' of register 'VO_MIXER1_OUTPUT_SYNC'. */
U8   GH_VO_MIXER1_get_OUTPUT_SYNC_sync_mode(void);
/*! \brief Writes the bit group 'number' of register 'VO_MIXER1_OUTPUT_SYNC'. */
void GH_VO_MIXER1_set_OUTPUT_SYNC_number(U8 data);
/*! \brief Reads the bit group 'number' of register 'VO_MIXER1_OUTPUT_SYNC'. */
U8   GH_VO_MIXER1_get_OUTPUT_SYNC_number(void);
/*! \brief Writes the bit group 'counter' of register 'VO_MIXER1_OUTPUT_SYNC'. */
void GH_VO_MIXER1_set_OUTPUT_SYNC_counter(U8 data);
/*! \brief Reads the bit group 'counter' of register 'VO_MIXER1_OUTPUT_SYNC'. */
U8   GH_VO_MIXER1_get_OUTPUT_SYNC_counter(void);
/*! \brief Writes the bit group 'sync' of register 'VO_MIXER1_OUTPUT_SYNC'. */
void GH_VO_MIXER1_set_OUTPUT_SYNC_sync(U8 data);
/*! \brief Reads the bit group 'sync' of register 'VO_MIXER1_OUTPUT_SYNC'. */
U8   GH_VO_MIXER1_get_OUTPUT_SYNC_sync(void);
/*! \brief Writes the bit group 'frame' of register 'VO_MIXER1_OUTPUT_SYNC'. */
void GH_VO_MIXER1_set_OUTPUT_SYNC_frame(U8 data);
/*! \brief Reads the bit group 'frame' of register 'VO_MIXER1_OUTPUT_SYNC'. */
U8   GH_VO_MIXER1_get_OUTPUT_SYNC_frame(void);
#else /* GH_INLINE_LEVEL == 0 */
GH_INLINE void GH_VO_MIXER1_set_OUTPUT_SYNC(U32 data)
{
...
GH_INLINE U32  GH_VO_MIXER1_get_OUTPUT_SYNC(void)
{
...
GH_INLINE void GH_VO_MIXER1_set_OUTPUT_SYNC_sync_mode(U8 data)
{
...
GH_INLINE U8   GH_VO_MIXER1_get_OUTPUT_SYNC_sync_mode(void)
{
...
GH_INLINE void GH_VO_MIXER1_set_OUTPUT_SYNC_number(U8 data)
{
    GH_VO_MIXER1_OUTPUT_SYNC_S d;
    d.all = *(volatile U32 *)REG_VO_MIXER1_OUTPUT_SYNC;
    d.bitc.number = data;
...
GH_INLINE U8   GH_VO_MIXER1_get_OUTPUT_SYNC_number(void)
{
    GH_VO_MIXER1_OUTPUT_SYNC_S tmp_value;
    U32 value = (*(volatile U32 *)REG_VO_MIXER1_OUTPUT_SYNC);
...
GH_INLINE void GH_VO_MIXER1_set_OUTPUT_SYNC_counter(U8 data)
{
    GH_VO_MIXER1_OUTPUT_SYNC_S d;
    d.all = *(volatile U32 *)REG_VO_MIXER1_OUTPUT_SYNC;
    d.bitc.counter = data;
...
GH_INLINE U8   GH_VO_MIXER1_get_OUTPUT_SYNC_counter(void)
{
    GH_VO_MIXER1_OUTPUT_SYNC_S tmp_value;
    U32 value = (*(volatile U32 *)REG_VO_MIXER1_OUTPUT_SYNC);
...
GH_INLINE void GH_VO_MIXER1_set_OUTPUT_SYNC_sync(U8 data)
{
    GH_VO_MIXER1_OUTPUT_SYNC_S d;
    d.all = *(volatile U32 *)REG_VO_MIXER1_OUTPUT_SYNC;
    d.bitc.sync = data;
...
GH_INLINE U8   GH_VO_MIXER1_get_OUTPUT_SYNC_sync(void)
{
    GH_VO_MIXER1_OUTPUT_SYNC_S tmp_value;
    U32 value = (*(volatile U32 *)REG_VO_MIXER1_OUTPUT_SYNC);
...
GH_INLINE void GH_VO_MIXER1_set_OUTPUT_SYNC_frame(U8 data)
{
    GH_VO_MIXER1_OUTPUT_SYNC_S d;
    d.all = *(volatile U32 *)REG_VO_MIXER1_OUTPUT_SYNC;
    d.bitc.frame = data;
...
GH_INLINE U8   GH_VO_MIXER1_get_OUTPUT_SYNC_frame(void)
{
    GH_VO_MIXER1_OUTPUT_SYNC_S tmp_value;
    U32 value = (*(volatile U32 *)REG_VO_MIXER1_OUTPUT_SYNC);
...
/*----------------------------------------------------------------------------*/
#if GH_INLINE_LEVEL == 0
/*! \brief Writes the register 'VO_MIXER1_SMEM_INPUT'. */
void GH_VO_MIXER1_set_SMEM_INPUT(U32 data);
/*! \brief Reads the register 'VO_MIXER1_SMEM_INPUT'. */
U32  GH_VO_MIXER1_get_SMEM_INPUT(void);
/*! \brief Writes the bit group 'luma_number' of register 'VO_MIXER1_SMEM_INPUT'. */
void GH_VO_MIXER1_set_SMEM_INPUT_luma_number(U8 data);
/*! \brief Reads the bit group 'luma_number' of register 'VO_MIXER1_SMEM_INPUT'. */
U8   GH_VO_MIXER1_get_SMEM_INPUT_luma_number(void);
/*! \brief Writes the bit group 'chroma_number' of register 'VO_MIXER1_SMEM_INPUT'. */
void GH_VO_MIXER1_set_SMEM_INPUT_chroma_number(U8 data);
/*! \brief Reads the bit group 'chroma_number' of register 'VO_MIXER1_SMEM_INPUT'. */
U8   GH_VO_MIXER1_get_SMEM_INPUT_chroma_number(void);
/*! \brief Writes the bit group 'osd_number' of register 'VO_MIXER1_SMEM_INPUT'. */
void GH_VO_MIXER1_set_SMEM_INPUT_osd_number(U8 data);
/*! \brief Reads the bit group 'osd_number' of register 'VO_MIXER1_SMEM_INPUT'. */
U8   GH_VO_MIXER1_get_SMEM_INPUT_osd_number(void);
/*! \brief Writes the bit group 'priority' of register 'VO_MIXER1_SMEM_INPUT'. */
void GH_VO_MIXER1_set_SMEM_INPUT_priority(U8 data);
/*! \brief Reads the bit group 'priority' of register 'VO_MIXER1_SMEM_INPUT'. */
U8   GH_VO_MIXER1_get_SMEM_INPUT_priority(void);
/*! \brief Writes the bit group 'video_length' of register 'VO_MIXER1_SMEM_INPUT'. */
void GH_VO_MIXER1_set_SMEM_INPUT_video_length(U8 data);
/*! \brief Reads the bit group 'video_length' of register 'VO_MIXER1_SMEM_INPUT'. */
U8   GH_VO_MIXER1_get_SMEM_INPUT_video_length(void);
/*! \brief Writes the bit group 'osd_length' of register 'VO_MIXER1_SMEM_INPUT'. */
void GH_VO_MIXER1_set_SMEM_INPUT_osd_length(U8 data);
/*! \brief Reads the bit group 'osd_length' of register 'VO_MIXER1_SMEM_INPUT'. */
U8   GH_VO_MIXER1_get_SMEM_INPUT_osd_length(void);
#else /* GH_INLINE_LEVEL == 0 */
GH_INLINE void GH_VO_MIXER1_set_SMEM_INPUT(U32 data)
{
...
GH_INLINE U32  GH_VO_MIXER1_get_SMEM_INPUT(void)
{
...
GH_INLINE void GH_VO_MIXER1_set_SMEM_INPUT_luma_number(U8 data)
{
...
GH_INLINE U8   GH_VO_MIXER1_get_SMEM_INPUT_luma_number(void)
{
...
GH_INLINE void GH_VO_MIXER1_set_SMEM_INPUT_chroma_number(U8 data)
{
    GH_VO_MIXER1_SMEM_INPUT_S d;
    d.all = *(volatile U32 *)REG_VO_MIXER1_SMEM_INPUT;
...
GH_INLINE U8   GH_VO_MIXER1_get_SMEM_INPUT_chroma_number(void)
{
    GH_VO_MIXER1_SMEM_INPUT_S tmp_value;
    U32 value = (*(volatile U32 *)REG_VO_MIXER1_SMEM_INPUT);
...
GH_INLINE void GH_VO_MIXER1_set_SMEM_INPUT_osd_number(U8 data)
{
    GH_VO_MIXER1_SMEM_INPUT_S d;
    d.all = *(volatile U32 *)REG_VO_MIXER1_SMEM_INPUT;
...
GH_INLINE U8   GH_VO_MIXER1_get_SMEM_INPUT_osd_number(void)
{
    GH_VO_MIXER1_SMEM_INPUT_S tmp_value;
    U32 value = (*(volatile U32 *)REG_VO_MIXER1_SMEM_INPUT);
...
GH_INLINE void GH_VO_MIXER1_set_SMEM_INPUT_priority(U8 data)
{
    GH_VO_MIXER1_SMEM_INPUT_S d;
    d.all = *(volatile U32 *)REG_VO_MIXER1_SMEM_INPUT;
...
GH_INLINE U8   GH_VO_MIXER1_get_SMEM_INPUT_priority(void)
{
    GH_VO_MIXER1_SMEM_INPUT_S tmp_value;
    U32 value = (*(volatile U32 *)REG_VO_MIXER1_SMEM_INPUT);
...
GH_INLINE void GH_VO_MIXER1_set_SMEM_INPUT_video_length(U8 data)
{
    GH_VO_MIXER1_SMEM_INPUT_S d;
    d.all = *(volatile U32 *)REG_VO_MIXER1_SMEM_INPUT;
...
GH_INLINE U8   GH_VO_MIXER1_get_SMEM_INPUT_video_length(void)
{
    GH_VO_MIXER1_SMEM_INPUT_S tmp_value;
    U32 value = (*(volatile U32 *)REG_VO_MIXER1_SMEM_INPUT);
...
GH_INLINE void GH_VO_MIXER1_set_SMEM_INPUT_osd_length(U8 data)
{
    GH_VO_MIXER1_SMEM_INPUT_S d;
    d.all = *(volatile U32 *)REG_VO_MIXER1_SMEM_INPUT;
...
GH_INLINE U8   GH_VO_MIXER1_get_SMEM_INPUT_osd_length(void)
{
    GH_VO_MIXER1_SMEM_INPUT_S tmp_value;
    U32 value = (*(volatile U32 *)REG_VO_MIXER1_SMEM_INPUT);
...
/*----------------------------------------------------------------------------*/
#if GH_INLINE_LEVEL == 0
/*! \brief Writes the register 'VO_MIXER1_SMEM_OUT'. */
void GH_VO_MIXER1_set_SMEM_OUT(U32 data);
/*! \brief Reads the register 'VO_MIXER1_SMEM_OUT'. */
U32  GH_VO_MIXER1_get_SMEM_OUT(void);
/*! \brief Writes the bit group 'luma_number' of register 'VO_MIXER1_SMEM_OUT'. */
void GH_VO_MIXER1_set_SMEM_OUT_luma_number(U8 data);
/*! \brief Reads the bit group 'luma_number' of register 'VO_MIXER1_SMEM_OUT'. */
U8   GH_VO_MIXER1_get_SMEM_OUT_luma_number(void);
/*! \brief Writes the bit group 'chroma_number' of register 'VO_MIXER1_SMEM_OUT'. */
void GH_VO_MIXER1_set_SMEM_OUT_chroma_number(U8 data);
/*! \brief Reads the bit group 'chroma_number' of register 'VO_MIXER1_SMEM_OUT'. */
U8   GH_VO_MIXER1_get_SMEM_OUT_chroma_number(void);
/*! \brief Writes the bit group 'priority' of register 'VO_MIXER1_SMEM_OUT'. */
void GH_VO_MIXER1_set_SMEM_OUT_priority(U8 data);
/*! \brief Reads the bit group 'priority' of register 'VO_MIXER1_SMEM_OUT'. */
U8   GH_VO_MIXER1_get_SMEM_OUT_priority(void);
#else /* GH_INLINE_LEVEL == 0 */
GH_INLINE void GH_VO_MIXER1_set_SMEM_OUT(U32 data)
{
...
GH_INLINE U32  GH_VO_MIXER1_get_SMEM_OUT(void)
{
...
GH_INLINE void GH_VO_MIXER1_set_SMEM_OUT_luma_number(U8 data)
{
...
GH_INLINE U8   GH_VO_MIXER1_get_SMEM_OUT_luma_number(void)
{
...
GH_INLINE void GH_VO_MIXER1_set_SMEM_OUT_chroma_number(U8 data)
{
    GH_VO_MIXER1_SMEM_OUT_S d;
    d.all = *(volatile U32 *)REG_VO_MIXER1_SMEM_OUT;
    d.bitc.chroma_number = data;
...
GH_INLINE U8   GH_VO_MIXER1_get_SMEM_OUT_chroma_number(void)
{
    GH_VO_MIXER1_SMEM_OUT_S tmp_value;
    U32 value = (*(volatile U32 *)REG_VO_MIXER1_SMEM_OUT);
...
GH_INLINE void GH_VO_MIXER1_set_SMEM_OUT_priority(U8 data)
{
    GH_VO_MIXER1_SMEM_OUT_S d;
    d.all = *(volatile U32 *)REG_VO_MIXER1_SMEM_OUT;
    d.bitc.priority = data;
...
GH_INLINE U8   GH_VO_MIXER1_get_SMEM_OUT_priority(void)
{
    GH_VO_MIXER1_SMEM_OUT_S tmp_value;
    U32 value = (*(volatile U32 *)REG_VO_MIXER1_SMEM_OUT);
...
/*----------------------------------------------------------------------------*/
#if GH_INLINE_LEVEL == 0
/*! \brief Writes the register 'VO_MIXER1_FRAME_ENABLE'. */
void GH_VO_MIXER1_set_FRAME_ENABLE(U32 data);
/*! \brief Reads the register 'VO_MIXER1_FRAME_ENABLE'. */
U32  GH_VO_MIXER1_get_FRAME_ENABLE(void);
/*! \brief Writes the bit group 'enable' of register 'VO_MIXER1_FRAME_ENABLE'. */
void GH_VO_MIXER1_set_FRAME_ENABLE_enable(U8 data);
/*! \brief Reads the bit group 'enable' of register 'VO_MIXER1_FRAME_ENABLE'. */
U8   GH_VO_MIXER1_get_FRAME_ENABLE_enable(void);
#else /* GH_INLINE_LEVEL == 0 */
GH_INLINE void GH_VO_MIXER1_set_FRAME_ENABLE(U32 data)
{
...
GH_INLINE U32  GH_VO_MIXER1_get_FRAME_ENABLE(void)
{
...
GH_INLINE void GH_VO_MIXER1_set_FRAME_ENABLE_enable(U8 data)
{
...
GH_INLINE U8   GH_VO_MIXER1_get_FRAME_ENABLE_enable(void)
{
...
/*----------------------------------------------------------------------------*/
#if GH_INLINE_LEVEL == 0
/*! \brief Writes the register 'VO_MIXER1_CLUT_B'. */
void GH_VO_MIXER1_set_CLUT_B(U16 index, U32 data);
/*! \brief Reads the register 'VO_MIXER1_CLUT_B'. */
U32  GH_VO_MIXER1_get_CLUT_B(U16 index);
#else /* GH_INLINE_LEVEL == 0 */
GH_INLINE void GH_VO_MIXER1_set_CLUT_B(U16 index, U32 data)
{
...
GH_INLINE U32  GH_VO_MIXER1_get_CLUT_B(U16 index)
{
