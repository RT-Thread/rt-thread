 ...
 * Change Logs:
 * Date           Author       Notes
 * 2026-04-21     wdfk-prog    add stm32f2 adc v2 configuration
 */

/**
 * @file adc_config_v2.h
 * @brief STM32F2 ADC V2 configuration defaults.
 */
...
/** @brief Default ADC clock prescaler for STM32F2. */
...
/** @brief Default ADC data alignment for STM32F2. */
...
/** @brief Default ADC sampling time for STM32F2. */
...
/** @brief Maximum regular sequence length supported by the STM32F2 driver. */
...
/** @brief STM32F2 legacy internal ADC source logical channel overrides. */
...
/** @brief Default STM32F2 ADC1 V2 object initializer. */
...
/** @brief Default STM32F2 ADC2 V2 object initializer. */
...
/** @brief Default STM32F2 ADC3 V2 object initializer. */
