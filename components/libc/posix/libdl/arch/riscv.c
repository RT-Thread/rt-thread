...
/**
 * @brief   Perform relocations on a loaded module.
 *
 * @param   module   is a pointer to the loaded module to be relocated.
 * @param   rel      is a pointer to the relocation entry.
 * @param   sym_val  is the symbol value associated with the relocation.
 *
...
int dlmodule_relocate(struct rt_dlmodule *module, Elf_Rel *rel, Elf_Addr sym_val)
{
    ...
    where = (Elf64_Addr *)((rt_uint8_t *)module->mem_space + rel->r_offset - module->vstart_addr);
