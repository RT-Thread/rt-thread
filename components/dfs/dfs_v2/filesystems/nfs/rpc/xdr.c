 ...
 */
#define XDR_FALSE       ((uint32_t) 0)
#define XDR_TRUE        ((uint32_t) 1)
 ...
 * XDR integers
 */
bool_t xdr_int(XDR* xdrs, int32_t* ip)
{
    switch (xdrs->x_op) {
    case XDR_ENCODE:
 ...
 */
bool_t xdr_u_int(XDR* xdrs, uint32_t* uip)
{
    return xdr_int(xdrs, uip);
}
 ...
 */
bool_t xdr_long(XDR* xdrs, int32_t* lp)
{
    return xdr_int(xdrs, lp);
}
 ...
 */
bool_t xdr_u_long(XDR* xdrs, uint32_t* ulp)
{
    return xdr_int(xdrs, ulp);
}
...
bool_t xdr_longlong_t (XDR * xdrs, int64_t* llp)
{
    switch (xdrs->x_op) {
    case XDR_ENCODE:
        return XDR_PUTLONG(xdrs, llp);
    case XDR_DECODE:
        return XDR_GETLONG(xdrs, llp);
    case XDR_FREE:
        return TRUE;
    }
    return FALSE;
...
{
    return xdr_longlong_t(xdrs, ullp);
}

/*
 * XDR short integers
 */
bool_t xdr_short(XDR* xdrs, int16_t* sp)
{
    bool_t ret;
    int32_t val;

    val = *sp;
    ret = xdr_int(xdrs, &val);
    *sp = val;
 ...
 */
bool_t xdr_u_short(XDR* xdrs, uint16_t* usp)
{
    return xdr_short(xdrs, usp);
}
