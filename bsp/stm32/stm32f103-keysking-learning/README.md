...
本文档是为Keysking STM32F103C8T6 学习板提供的BSP(板级支持包)说明。
...
Keysking STM32F103C8T6 学习板是B站UP主Keysking推出的一块基于ARM Cortex-M3内核的开发板，最高主频为72MHz。
...
STM32F103C8T6的Flash在官方文档中的大小是64KB，但是其实该芯片与F103RBT6是一致的，RBT6出厂时完整测试了128KB的Flash情况，而C8T6只保证前64KB是正常运行的。
