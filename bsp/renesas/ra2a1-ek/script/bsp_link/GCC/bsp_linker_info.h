...
#define BSP_PARTITION_RAM_CPU0_START (0x20000000)
#define BSP_PARTITION_RAM_CPU0_SIZE (0x8000)
#define BSP_PARTITION_FLASH_CPU0_START (0x00000000)
#define BSP_PARTITION_FLASH_CPU0_SIZE (0x40000)
#define BSP_PARTITION_DATA_FLASH_CPU0_START (0x40100000)
#define BSP_PARTITION_DATA_FLASH_CPU0_SIZE (0x2000)
