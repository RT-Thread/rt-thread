...
typedef union
{
    struct
    {
        uint32_t C: 1;                       /*!< bit:      0  Ìõ¼þÂë£¯½øÎ»Î» */
        uint32_t _reserved0: 5;              /*!< bit:  2.. 5  ±£Áô */
        uint32_t IE: 1;                      /*!< bit:      6  ÖÐ¶ÏÓÐÐ§¿ØÖÆÎ» */
        uint32_t IC: 1;                      /*!< bit:      7  ÖÐ¶Ï¿ØÖÆÎ» */
        uint32_t EE: 1;                      /*!< bit:      8  Òì³£ÓÐÐ§¿ØÖÆÎ» */
        uint32_t MM: 1;                      /*!< bit:      9  ²»¶ÔÆëÒì³£ÑÚ¸ÇÎ» */
        uint32_t _reserved1: 6;              /*!< bit: 10..15  ±£Áô */
        uint32_t VEC: 8;                     /*!< bit: 16..23  Òì³£ÊÂ¼þÏòÁ¿Öµ */
...
typedef union
{
    struct
    {
        ...
        uint32_t BE_V2: 1;                   /*!< bit:     13  V2°æ±¾´óÐ¡¶Ë */
...
/**
  \brief  ·ÃÎÊ¿É¸ß»ººÍ·ÃÎÊÈ¨ÏÞÅäÖÃ¼Ä´æÆ÷(CAPR, CR<19,0>)µÄÁªºÏÌå¶¨Òå..
 */
typedef union
{
    struct
    {
        uint32_t X0: 1;                      /*!< bit:      0  ²»¿ÉÖ´ÐÐÊôÐÔÉèÖÃÎ» */
        uint32_t X1: 1;                      /*!< bit:      1  ²»¿ÉÖ´ÐÐÊôÐÔÉèÖÃÎ» */
        uint32_t X2: 1;                      /*!< bit:      2  ²»¿ÉÖ´ÐÐÊôÐÔÉèÖÃÎ» */
        uint32_t X3: 1;                      /*!< bit:      3  ²»¿ÉÖ´ÐÐÊôÐÔÉèÖÃÎ» */
        uint32_t X4: 1;                      /*!< bit:      4  ²»¿ÉÖ´ÐÐÊôÐÔÉèÖÃÎ» */
        uint32_t X5: 1;                      /*!< bit:      5  ²»¿ÉÖ´ÐÐÊôÐÔÉèÖÃÎ» */
        uint32_t X6: 1;                      /*!< bit:      6  ²»¿ÉÖ´ÐÐÊôÐÔÉèÖÃÎ» */
        uint32_t X7: 1;                      /*!< bit:      7  ²»¿ÉÖ´ÐÐÊôÐÔÉèÖÃÎ» */
        uint32_t AP0: 2;                     /*!< bit:  8.. 9  ·ÃÎÊÈ¨ÏÞÉèÖÃÎ» */
        uint32_t AP1: 2;                     /*!< bit: 10..11  ·ÃÎÊÈ¨ÏÞÉèÖÃÎ» */
        uint32_t AP2: 2;                     /*!< bit: 12..13  ·ÃÎÊÈ¨ÏÞÉèÖÃÎ» */
        uint32_t AP3: 2;                     /*!< bit: 14..15  ·ÃÎÊÈ¨ÏÞÉèÖÃÎ» */
        uint32_t AP4: 2;                     /*!< bit: 16..17  ·ÃÎÊÈ¨ÏÞÉèÖÃÎ» */
        uint32_t AP5: 2;                     /*!< bit: 18..19  ·ÃÎÊÈ¨ÏÞÉèÖÃÎ» */
        uint32_t AP6: 2;                     /*!< bit: 20..21  ·ÃÎÊÈ¨ÏÞÉèÖÃÎ» */
        uint32_t AP7: 2;                     /*!< bit: 22..23  ·ÃÎÊÈ¨ÏÞÉèÖÃÎ» */
        uint32_t S0: 1;                      /*!< bit:     24  °²È«ÊôÐÔÉèÖÃÎ» */
        uint32_t S1: 1;                      /*!< bit:     25  °²È«ÊôÐÔÉèÖÃÎ» */
        uint32_t S2: 1;                      /*!< bit:     26  °²È«ÊôÐÔÉèÖÃÎ» */
        uint32_t S3: 1;                      /*!< bit:     27  °²È«ÊôÐÔÉèÖÃÎ» */
        uint32_t S4: 1;                      /*!< bit:     28  °²È«ÊôÐÔÉèÖÃÎ» */
        uint32_t S5: 1;                      /*!< bit:     29  °²È«ÊôÐÔÉèÖÃÎ» */
        uint32_t S6: 1;                      /*!< bit:     30  °²È«ÊôÐÔÉèÖÃÎ» */
        uint32_t S7: 1;                      /*!< bit:     31  °²È«ÊôÐÔÉèÖÃÎ» */
    } b;                                   /*!< Structure    ÓÃÀ´°´Î»·ÃÎÊ */
    uint32_t w;                            /*!< Type         Õû¸ö¼Ä´æÆ÷·ÃÎÊ */
} CAPR_Type;
...
typedef union
{
    struct
    {
        uint32_t E: 1;                       /*!< bit:      0  ±£»¤ÇøÓÐÐ§ÉèÖÃ */
        uint32_t Size: 5;                    /*!< bit:  1.. 5  ±£»¤Çø´óÐ¡ */
...
typedef union
{
    struct
    {
        uint32_t RID: 3;                     /*!< bit:  0.. 2  ±£»¤ÇøË÷ÒýÖµ */
...
/**
  \brief ·ÃÎÊÊ¸Á¿ÖÐ¶Ï¿ØÖÆÆ÷µÄ½á¹¹Ìå.
 */
typedef struct
{
    __IOM uint32_t ISER[1U];               /*!< Offset: 0x000 (R/W)  ÖÐ¶ÏÊ¹ÄÜÉèÖÃ¼Ä´æÆ÷ */
    uint32_t RESERVED0[15U];
    __IOM uint32_t IWER[1U];               /*!< Offset: 0x040 (R/W)  ÖÐ¶ÏµÍ¹¦ºÄ»½ÐÑÉèÖÃ¼Ä´æÆ÷ */
    uint32_t RESERVED1[15U];
    __IOM uint32_t ICER[1U];               /*!< Offset: 0x080 (R/W)  ÖÐ¶ÏÊ¹ÄÜÇå³ý¼Ä´æÆ÷ */
    uint32_t RESERVED2[15U];
    __IOM uint32_t IWDR[1U];               /*!< Offset: 0x0c0 (R/W)  ÖÐ¶ÏµÍ¹¦ºÄ»½ÐÑÇå³ý¼Ä´æÆ÷ */
    uint32_t RESERVED3[15U];
    __IOM uint32_t ISPR[1U];               /*!< Offset: 0x100 (R/W)  ÖÐ¶ÏµÈ´ýÉèÖÃ¼Ä´æÆ÷ */
    uint32_t RESERVED4[15U];
    __IOM uint32_t ISSR[1U];               /*!< Offset: 0x140 (R/W)  °²È«ÖÐ¶ÏÊ¹ÄÜÉèÖÃ¼Ä´æÆ÷ */
    uint32_t RESERVED5[15U];
    __IOM uint32_t ICPR[1U];               /*!< Offset: 0x180 (R/W)  ÖÐ¶ÏµÈ´ýÇå³ý¼Ä´æÆ÷ */
    uint32_t RESERVED6[31U];
    __IOM uint32_t IABR[1U];               /*!< Offset: 0x200 (R/W)  ÖÐ¶ÏÏìÓ¦×´Ì¬¼Ä´æÆ÷ */
    uint32_t RESERVED7[63U];
    __IOM uint32_t IPR[8U];                /*!< Offset: 0x300 (R/W)  ÖÐ¶ÏÓÅÏÈ¼¶ÉèÖÃ¼Ä´æÆ÷ */
    uint32_t RESERVED8[504U];
    __IM  uint32_t ISR;                    /*!< Offset: 0xB00 (R/ )  ÖÐ¶Ï×´Ì¬¼Ä´æÆ÷ */
    __IOM uint32_t IPTR;                   /*!< Offset: 0xB04 (R/W)  ÖÐ¶ÏÓÅÏÈ¼¶ãÐÖµ¼Ä´æÆ÷ */
} NVIC_Type;
...
typedef struct
{
    ...
    __IM  uint32_t CALIB;                  /*!< Offset: 0x00C (R/ )  Ð£×¼¼Ä´æÆ÷ */
} CORET_Type;
...
typedef struct
{
    ...
    union
    {
        __IM uint32_t DERJW;                 /*!< Offset: 0x058 (R/ )  Êý¾Ý½»»»¼Ä´æÆ÷ CPU¶Á*/
        __OM uint32_t DERJR;                 /*!< Offset: 0x058 ( /W)  Êý¾Ý½»»»¼Ä´æÆ÷ CPUÐ´*/
    };
