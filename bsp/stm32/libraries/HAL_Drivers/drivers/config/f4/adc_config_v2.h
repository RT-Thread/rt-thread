 ...
 * Change Logs:
 * Date           Author       Notes
 * 2026-04-21     wdfk-prog    add stm32f4 adc v2 configuration
 */

/**
 * @file adc_config_v2.h
 * @brief STM32F4 ADC V2 configuration defaults.
 */
...
/** @brief Default ADC clock prescaler for STM32F4. */
...
/** @brief Default ADC data alignment for STM32F4. */
...
/** @brief Default ADC sampling time for STM32F4. */
#if defined(ADC_SAMPLETIME_112CYCLES)
#define ADC_DEFAULT_SAMPLING_TIME ADC_SAMPLETIME_112CYCLES
#else
#define ADC_DEFAULT_SAMPLING_TIME 0U
#endif /* defined(ADC_SAMPLETIME_112CYCLES) */


/** @brief Maximum regular sequence length supported by the STM32F4 driver. */
...
/** @brief STM32F4 legacy internal ADC source logical channel overrides. */
...
/** @brief Default STM32F4 ADC1 V2 object initializer. */
...
/** @brief Default STM32F4 ADC2 V2 object initializer. */
...
/** @brief Default STM32F4 ADC3 V2 object initializer. */
