...
static struct rt_clk_cell *rk3568_clk_cells[] =
{
    ...
    [PLL_VPLL] = &rk3568_pll_vpll.rk_cell.cell,
    [PLL_NPLL] = &rk3568_pll_npll.rk_cell.cell,
    ...
    [DCLK_VOP0] = COMPOSITE(DCLK_VOP0, "dclk_vop0", hpll_vpll_gpll_cpll_p, RT_CLK_F_SET_RATE_NO_REPARENT,
            RK3568_CLKSEL_CON(39), 10, 2, MFLAGS, 0, 8, DFLAGS,
            RK3568_CLKGATE_CON(20), 10, GFLAGS),
    [DCLK_VOP1] = COMPOSITE(DCLK_VOP1, "dclk_vop1", hpll_vpll_gpll_cpll_p, RT_CLK_F_SET_RATE_NO_REPARENT,
            RK3568_CLKSEL_CON(40), 10, 2, MFLAGS, 0, 8, DFLAGS,
            RK3568_CLKGATE_CON(20), 11, GFLAGS),
    [DCLK_VOP2] = COMPOSITE(DCLK_VOP2, "dclk_vop2", hpll_vpll_gpll_cpll_p, RT_CLK_F_SET_RATE_NO_REPARENT,
