 ...
 * Change Logs:
 * Date           Author       Notes
 * 2026-04-21     wdfk-prog    add stm32f7 adc v2 configuration
 */

/**
 * @file adc_config_v2.h
 * @brief STM32F7 ADC V2 configuration defaults.
 */
...
/** @brief Default ADC clock prescaler for STM32F7. */
...
/** @brief Default ADC data alignment for STM32F7. */
...
/** @brief Default ADC sampling time for STM32F7. */
...
/** @brief Maximum regular sequence length supported by the STM32F7 driver. */
...
/** @brief STM32F7 legacy internal ADC source logical channel overrides. */
...
/** @brief Default STM32F7 ADC1 V2 object initializer. */
...
/** @brief Default STM32F7 ADC2 V2 object initializer. */
...
/** @brief Default STM32F7 ADC3 V2 object initializer. */
