...
#ifndef __APM32S10X_CAN_H
#define __APM32S10X_CAN_H
...
/**
 * @brief CAN configure structure definition
 */
typedef struct
{
...
/**
 * @brief     CAN filter configure structure definition
 */
typedef struct
{
