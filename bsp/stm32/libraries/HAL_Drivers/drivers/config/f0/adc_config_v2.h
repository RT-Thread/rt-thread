 ...
 * Change Logs:
 * Date           Author       Notes
 * 2026-04-21     wdfk-prog    add stm32f0 adc v2 configuration
 */

/**
 * @file adc_config_v2.h
 * @brief STM32F0 ADC V2 configuration defaults.
 */
...
/** @brief Default ADC clock prescaler for STM32F0. */
...
/** @brief Default ADC data alignment for STM32F0. */
...
/** @brief Default ADC sampling time for STM32F0. */
#if defined(ADC_SAMPLETIME_71CYCLES_5)
#define ADC_DEFAULT_SAMPLING_TIME ADC_SAMPLETIME_71CYCLES_5
#else
#define ADC_DEFAULT_SAMPLING_TIME 0U
#endif /* defined(ADC_SAMPLETIME_71CYCLES_5) */


/** @brief Maximum regular sequence length supported by the STM32F0 driver. */
...
/** @brief STM32F0 legacy internal ADC source logical channel overrides. */
...
/** @brief Default STM32F0 ADC1 V2 object initializer. */
...
/** @brief Default STM32F0 ADC2 V2 object initializer. */
...
/** @brief Default STM32F0 ADC3 V2 object initializer. */
