...
#ifndef __APM32S10X_H
#define __APM32S10X_H
...
/*!
 *  APM32S10X_MD: APM32 Medium density devices, the Flash memory density ranges between 64 and 128 Kbytes.
 */
#if !defined (APM32S10X_MD)
#error "Please select a the target APM32S10x device used in your application (in apm32s10x.h file)"
#endif
...
/** @defgroup APM32S10x_StdPeripheral_Library_Version
  @{
*/

/*!
 * @brief APM32S10x Standard Peripheral Library version number
 */
#define __APM32S10X_STDPERIPH_VERSION_MAIN   (0x01) /*!< [31:24] main version */
#define __APM32S10X_STDPERIPH_VERSION_SUB1   (0x00) /*!< [23:16] sub1 version */
#define __APM32S10X_STDPERIPH_VERSION_SUB2   (0x00) /*!< [15:8]  sub2 version */
#define __APM32S10X_STDPERIPH_VERSION_RC     (0x00) /*!< [7:0]  release candidate */
#define __APM32S10X_STDPERIPH_VERSION       ( (__APM32S10X_STDPERIPH_VERSION_MAIN << 24)\
                                             |(__APM32S10X_STDPERIPH_VERSION_SUB1 << 16)\
                                             |(__APM32S10X_STDPERIPH_VERSION_SUB2 << 8)\
                                             |(__APM32S10X_STDPERIPH_VERSION_RC))

/**@} end of group APM32S10x_StdPeripheral_Library_Version */
...
/*!
 * @brief APM32S10x Interrupt Number Definition, according to the selected device
...
typedef enum IRQn
{
...
#if defined (APM32S10X_MD)
    /*  APM32S10X Medium-density devices specific Interrupt Numbers */
    ...
    USBD2_HP_CAN2_TX_IRQn       = 45,     /*!< USB Device 2 High Priority or CAN2 TX Interrupts     */
    USBD2_LP_CAN2_RX0_IRQn      = 46,     /*!< USB Device 2 Low Priority or CAN2 RX0 Interrupts     */
