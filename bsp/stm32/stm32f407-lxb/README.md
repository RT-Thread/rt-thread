# LXB407ZGT6-P1 开发板 BSP 说明

## 简介

本文档为鹿小班（LXB）LXB407ZGT6-P1 开发板的 BSP (板级支持包) 说明。
...
LXB407ZGT6-P1 是鹿小班科技推出的一款基于 ARM Cortex-M4 内核的核心板，主控为 STM32F407ZGT6，最高频率为 168MHz，具有 1MB FLASH、192KB RAM。
...
- 常用外设
  - LED：用户LED（PC13，低电平点亮）
  - 按键：用户按键、复位按键
- 常用接口：USB 接口（Type-C）、TF 卡接口（SDIO）、LCD 接口等
- 调试接口：SWD + 串口

开发板更多详细信息请参考板子附带的原理图与参考例程。
