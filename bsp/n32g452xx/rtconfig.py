...
if PLATFORM == 'gcc':
    ...
    LFLAGS = DEVICE + ' -Wl,--gc-sections,-Map=rtthread.map,-cref,-u,Reset_Handler -T n32_rom.lds'
    ...
    AFLAGS = DEVICE
    LFLAGS = DEVICE + ' --info sizes --info totals --info unused --info veneers --list rtthread.map --scatter n32_rom.sct'
    ...
    DEVICE = ' -D USE_STDPERIPH_DRIVER' + ' -D N32G45X'
