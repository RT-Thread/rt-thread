...
{
    GPIO_Module *gpio_grp; // pwmgpio
    uint16_t pin;          // pwm gpio pin
...
static rt_err_t drv_pwm_get(struct n32_pwm *pwm, struct rt_pwm_configuration *configuration)
{
    ...
    /* convet ns Convert nanosecond to frequency and duty cycle. 1s = 1 * 1000 * 1000 * 1000 ns */
    // UNIT MHz
    tim_clock /= 1000000UL;
    // period time
