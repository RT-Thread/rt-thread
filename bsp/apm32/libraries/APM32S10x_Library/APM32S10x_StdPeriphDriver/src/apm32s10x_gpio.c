 ...
 *                  This parameter can be one of GPIOx( x can be from A to E).
 *
 * @retval    None
 */
...
/*!
 * @brief     Configure the GPIO peripheral according to the specified parameters in the gpioConfig
 *
 * @param     port: Select the GPIO port.
 *                  This parameter can be one of GPIOx( x can be from A to E).
 *
...
/*!
 * @brief     Fill each gpioConfig member with its default value.
 *
 ...
 *                  This parameter can be one of GPIOx( x can be from A to E).
 *
 * @param     pin : specify pin to be written.
 ...
 *                  This parameter can be one of GPIOx( x can be from A to E).
 *
 * @param     pin : specify pin to be cleared.
 *                  This parameter can be any combination of GPIO_PIN_x( x can be from 0 to 15).
 *
 * @retval    None
 */
...
/*!
 * @brief     Write data to the specified GPIO data port bit
 *
 * @param     port: Select the GPIO port.
 *                  This parameter can be one of GPIOx( x can be from A to E).
 *
 ...
 *                  This parameter can be one of GPIO_PIN_x( x can be from 0 to 15).
 *
 * @param     bitVal : specify the value to be written to the port output data register
 ...
 *                  This parameter can be one of GPIOx( x can be from A to E).
 *
 * @param     portValue : specify the value to be written to the port output data register.
 *
 * @retval    None
 */
 ...
 *
 * @param     portSource: select the GPIO port to be used as source for Event output.
 *                         This parameter can be one of GPIO_PORT_SOURCE_x( x can be from A to E).
 *
 * @param     pinSource : specify the pin for the Event output
 ...
 *
 * @param     remap : select the pin to remap
 *                    This parameter can be one of the following values:
...
/*!
 * @brief     Select the GPIO pin used as EINT Line
 *
 * @param     portSource : select the GPIO port to be used as source for EINT line.
 *                         This parameter can be one of GPIO_PORT_SOURCE_x( x can be from A to E).
 *
 * @param     pinSource : Specify the EINT line to be configured.
 *                        This parameter can be GPIO_PIN_SOURCE_x( x can be from 0 to 15).
 *
 * @retval    None
 */
