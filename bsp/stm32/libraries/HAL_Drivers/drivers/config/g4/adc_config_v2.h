 ...
 * Change Logs:
 * Date           Author       Notes
 * 2026-04-21     wdfk-prog    add stm32g4 adc v2 configuration
 */

/**
 * @file adc_config_v2.h
 * @brief STM32G4 ADC V2 configuration defaults.
 */
...
/** @brief Default ADC clock prescaler for STM32G4. */
...
/** @brief Default ADC data alignment for STM32G4. */
...
/** @brief Default ADC sampling time for STM32G4. */
...
#endif /* defined(ADC_SAMPLETIME_247CYCLES_5) */


/** @brief Maximum regular sequence length supported by the STM32G4 driver. */
...
/** @brief STM32G4 VBAT HAL ADC channel for the multi-instance route. */
#define STM32_ADC_VBAT_HAL_CHANNEL ADC_CHANNEL_VBAT
/** @brief STM32G4 ADC instances that can sample VBAT. */
#define STM32_ADC_VBAT_INSTANCE_MASK ((1UL << 0) | (1UL << 2) | (1UL << 4))
#endif /* defined(ADC_CHANNEL_VBAT) */

#if defined(ADC_CHANNEL_VREFINT)
/** @brief STM32G4 VREFINT HAL ADC channel for the multi-instance route. */
#define STM32_ADC_VREF_HAL_CHANNEL ADC_CHANNEL_VREFINT
/** @brief STM32G4 ADC instances that can sample VREFINT. */
#define STM32_ADC_VREF_INSTANCE_MASK ((1UL << 0) | (1UL << 2) | (1UL << 3) | (1UL << 4))
#endif /* defined(ADC_CHANNEL_VREFINT) */

#if defined(ADC_CHANNEL_TEMPSENSOR_ADC5)
/** @brief STM32G4 alternate temperature sensor HAL ADC channel. */
#define STM32_ADC_TEMP_ALT_HAL_CHANNEL ADC_CHANNEL_TEMPSENSOR_ADC5
/** @brief STM32G4 ADC instances that can sample the alternate temperature sensor channel. */
#define STM32_ADC_TEMP_ALT_INSTANCE_MASK (1UL << 4)
#endif /* defined(ADC_CHANNEL_TEMPSENSOR_ADC5) */
...
/** @brief Default STM32G4 ADC1 V2 object initializer. */
...
/** @brief Default STM32G4 ADC2 V2 object initializer. */
...
/** @brief Default STM32G4 ADC3 V2 object initializer. */
...
/** @brief Default STM32G4 ADC4 V2 object initializer. */
