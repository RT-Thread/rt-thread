...
#endif
#ifndef PTE_VENDOR_MTMASK
#define PTE_VENDOR_MTMASK               PTE_ATTR_NONE
#endif
...
#elif defined(ARCH_MM_MMU_SV48)
#define ARCH_VADDR_WIDTH                48
#elif defined(ARCH_MM_MMU_SV57)
...
void rt_hw_mmu_tbl_set(rt_ubase_t tbl);
