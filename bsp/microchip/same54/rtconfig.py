...
DEVICE_SERIES = 'SAME54'
#DEVICE_SERIES = 'SAME53'
#DEVICE_SERIES = 'SAME51'
#DEVICE_SERIES = 'SAMD51'
DEVICE_TYPE = '__SAME54P20A__'
#DEVICE_TYPE = '__SAME53N20A__'
DEVICE_PART = 'same54'
...
if PLATFORM == 'gcc':
    ...
    LFLAGS = DEVICE + ' -Wl,-Map=rt-thread-' + DEVICE_PART + '.map,-cref,-u,Reset_Handler -T bsp/gcc/gcc/same54p20a_flash.ld'
