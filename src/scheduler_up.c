...
static inline struct rt_thread *_scheduler_get_priority_thread(rt_ubase_t priority)
{
    /* get highest ready priority thread */
    return RT_THREAD_LIST_NODE_ENTRY(rt_thread_priority_table[priority].next);
}
