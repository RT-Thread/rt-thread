...
CPU='cortex-m33'
CROSS_TOOL='gcc'
BOARD_NAME = 'frdm-mcxa366'
BSP_LIBRARY_TYPE = 'MCXA366'
...
if PLATFORM == 'gcc':
    ...
    LFLAGS = DEVICE + ' -specs=nano.specs -specs=nosys.specs -Wl,--defsym=__heap_size__=0x8000,--gc-sections,-Map=rtthread.map,--print-memory-usage -Tboard/linker_scripts/MCXA366_flash.ld'
    ...
    AFLAGS = DEVICE
    LFLAGS = DEVICE + ' --libpath "' + EXEC_PATH + '/ARM/ARMCC/lib" --info sizes --info totals --info unused --info veneers --list rtthread.map --scatter "./board/linker_scripts/MCXA366_flash.scf" '
    ...
    LFLAGS += r' --strict --scatter "packages\nxp-mcx-series-latest\MCXA366\arm\MCXA366_flash.scf" '
    ...
    LFLAGS = ' --config "packages/nxp-mcx-series-latest/MCXA366/iar/MCXA366_flash.icf"'
