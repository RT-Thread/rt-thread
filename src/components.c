...
#endif
#ifndef RT_MAIN_THREAD_PRIO
#define RT_MAIN_THREAD_PRIO           RT_THREAD_PRIORITY_MAX / 3          
#endif
#endif
...
void rt_application_init(void)
{
    ...
    tid = rt_thread_create("main", main_thread_entry, RT_NULL,
                           RT_MAIN_THREAD_STACK_SIZE, RT_MAIN_THREAD_PRIO, 20);
    ...
    result = rt_thread_init(tid, "main", main_thread_entry, RT_NULL,
                            main_stack, sizeof(main_stack), RT_MAIN_THREAD_PRIO, 20);
