 ...
 *\*\       in Cube-generated board code. This driver only handles peripheral configuration.
 */
struct n32_fdcan
{
    const char *name;                   /**< device name */
    const struct n32_fdcan_config *config;       /**< instance resource configuration */
    FDCAN_Module *fdcan_x;              /**< FDCAN peripheral base address */
