...
#define RT_UTEST_PIN
#define RT_UTEST_PIN_OUT_NAME ""
#define RT_UTEST_PIN_IN_NAME ""
#define RT_UTEST_PIN_OUT_NUM -1
#define RT_UTEST_PIN_IN_NUM -1
#define RT_UTEST_PIN_SETTLE_MS 2
#define RT_UTEST_PIN_IRQ_TIMEOUT_MS 500
#define RT_UTEST_PIN_IRQ
/* end of Pin Test */
