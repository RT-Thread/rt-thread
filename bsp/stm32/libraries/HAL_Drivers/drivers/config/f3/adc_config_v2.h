 ...
 * Change Logs:
 * Date           Author       Notes
 * 2026-04-21     wdfk-prog    add stm32f3 adc v2 configuration
 */

/**
 * @file adc_config_v2.h
 * @brief STM32F3 ADC V2 configuration defaults.
 */
...
/** @brief Default ADC clock prescaler for STM32F3. */
...
/** @brief Default ADC data alignment for STM32F3. */
...
/** @brief Default ADC sampling time for STM32F3. */
#if defined(ADC_SAMPLETIME_181CYCLES_5)
#define ADC_DEFAULT_SAMPLING_TIME ADC_SAMPLETIME_181CYCLES_5
#else
#define ADC_DEFAULT_SAMPLING_TIME 0U
#endif /* defined(ADC_SAMPLETIME_181CYCLES_5) */


/** @brief Maximum regular sequence length supported by the STM32F3 driver. */
...
/** @brief STM32F3 legacy internal ADC source logical channel overrides. */
...
/** @brief STM32F3 VREFINT HAL ADC channel for the multi-instance route. */
#define STM32_ADC_VREF_HAL_CHANNEL ADC_CHANNEL_VREFINT
/** @brief STM32F3 ADC instances that can sample VREFINT. */
#define STM32_ADC_VREF_INSTANCE_MASK ((1UL << 0) | (1UL << 1) | (1UL << 2) | (1UL << 3))
...
/** @brief Default STM32F3 ADC1 V2 object initializer. */
...
/** @brief Default STM32F3 ADC2 V2 object initializer. */
...
/** @brief Default STM32F3 ADC3 V2 object initializer. */
...
/** @brief Default STM32F3 ADC4 V2 object initializer. */
