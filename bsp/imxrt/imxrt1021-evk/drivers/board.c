...
static void BOARD_BootClockRUN(void)
{
    ...
    /* Setting the VDD_SOC to 1.25V. It is necessary to config AHB to max 500Mhz */
    DCDC->REG3 = (DCDC->REG3 & (~DCDC_REG3_TRG_MASK)) | DCDC_REG3_TRG(0x12);

#if defined (CPU_MIMXRT1021DAF5A) || defined (CPU_MIMXRT1021DAG5A)
    CLOCK_InitEnetPll(&enetPllConfig); /* Configure ENET PLL to 500M for AHBCLK */
#elif defined (CPU_MIMXRT1021CAF4A) || defined (CPU_MIMXRT1021CAG4A)
    CLOCK_InitSysPll(&sysPllConfig); /* Configure SYS PLL */
    CLOCK_InitSysPfd(kCLOCK_Pfd3, 24);/* PLL2_PFD3 = 396MHz for AHB CLOOK ROOT */
#endif
...
#endif
#if defined (CPU_MIMXRT1021DAF5A) || defined (CPU_MIMXRT1021DAG5A)	
    CLOCK_SetDiv(kCLOCK_ArmDiv, 0x0); /* Set ARM PODF to 0, divide by 2 */
    CLOCK_SetDiv(kCLOCK_AhbDiv, 0x0); /* Set AHB PODF to 0, divide by 1 */
    CLOCK_SetDiv(kCLOCK_IpgDiv, 0x3); /* Set IPG PODF to 3, divede by 4 */

    CLOCK_SetMux(kCLOCK_PrePeriphMux, 0x3); /* Set PRE_PERIPH_CLK to PLL6, 500M */
    CLOCK_SetMux(kCLOCK_PeriphMux, 0x0); /* Set PERIPH_CLK MUX to PRE_PERIPH_CLK */
#elif defined (CPU_MIMXRT1021CAF4A) || defined (CPU_MIMXRT1021CAG4A)
    CLOCK_SetDiv(kCLOCK_ArmDiv, 0x0); /* Set ARM PODF to 0, divide by 1 */
    CLOCK_SetDiv(kCLOCK_AhbDiv, 0x0); /* Set AHB PODF to 0, divide by 1 */
    CLOCK_SetDiv(kCLOCK_IpgDiv, 0x2); /* Set IPG PODF to 2, divede by 3 */

    CLOCK_SetMux(kCLOCK_PrePeriphMux, 0x2); /* Set PRE_PERIPH_CLK to PLL2_PFD3, 396MHz */
    CLOCK_SetMux(kCLOCK_PeriphMux, 0x0); /* Set PERIPH_CLK MUX to PRE_PERIPH_CLK */
#endif
...
/**
 * This function will initial rt1021 board.
 */
