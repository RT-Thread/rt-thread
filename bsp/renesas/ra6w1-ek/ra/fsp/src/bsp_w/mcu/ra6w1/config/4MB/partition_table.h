 ...
 ****************************************************************************************
 *
 * @file ra6w1/config/4MB/partition_table.h
 *
...
#define NVMS_FIRMWARE_PART_START          SF_RTOS_0
#define NVMS_FIRMWARE_PART_SIZE           SF_RTOS_SIZE

#define NVMS_LOG_PART_START               SF_TLS_CERT_BASE_ADDR
#define NVMS_LOG_PART_SIZE                SF_USER_AREA_SIZE

#define NVMS_GENERIC_PART_START           SF_NVRAM_AREA
#define NVMS_GENERIC_PART_SIZE            (SF_NVRAM_SIZE * 2)
...
PARTITION2(NVMS_FIRMWARE_PART, 0)                          // RTOS #0
