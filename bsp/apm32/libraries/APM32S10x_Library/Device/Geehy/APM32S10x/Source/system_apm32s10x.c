...
/** @addtogroup APM32S10x_System
  * @brief APM32S10x system configuration
  @{
*/
...
/*!
 * @brief       Select HSE as System clock source and configure HCLK, PCLK2 and PCLK1 prescalers
 *
 * @param       None
 *
 * @retval      None
...
#elif defined SYSTEM_CLOCK_24MHz
/*!
 * @brief       Set System clock frequency to 24MHz and configure HCLK, PCLK2 and PCLK1 prescalers
 *
 * @param       None
 *
 * @retval      None
...
#elif defined SYSTEM_CLOCK_36MHz
/*!
 * @brief       Set System clock frequency to 36MHz and configure HCLK, PCLK2 and PCLK1 prescalers
 *
 * @param       None
 *
 * @retval      None
...
#elif defined SYSTEM_CLOCK_48MHz
/*!
 * @brief       Set System clock frequency to 46MHz and configure HCLK, PCLK2 and PCLK1 prescalers
 *
 * @param       None
 *
 * @retval      None
...
#elif defined SYSTEM_CLOCK_56MHz
/*!
 * @brief       Set System clock frequency to 56MHz and configure HCLK, PCLK2 and PCLK1 prescalers
 *
 * @param       None
 *
 * @retval      None
...
#elif defined SYSTEM_CLOCK_72MHz
/*!
 * @brief       Set System clock frequency to 72MHz and configure HCLK, PCLK2 and PCLK1 prescalers
 *
 * @param       None
 *
 * @retval      None
...
#elif defined SYSTEM_CLOCK_96MHz
/*!
 * @brief       Set System clock frequency to 96MHz and configure HCLK, PCLK2 and PCLK1 prescalers
 *
 * @param       None
 *
 * @retval      None
