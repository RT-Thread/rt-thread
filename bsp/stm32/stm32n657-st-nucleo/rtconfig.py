...
if PLATFORM == 'gcc':
    ...
    DEVICE = ' -march=armv8.1-m.main -mthumb -mfpu=fpv5-d16 -mfloat-abi=hard -mcmse -ffunction-sections -fdata-sections'
    CFLAGS = DEVICE + ' -Dgcc' + ' -DDEBUG -DUSE_HAL_DRIVER -DSTM32N657xx -DUSE_NUCLEO_64 -Wall -fstack-usage -mcmse  -Wno-tautological-compare'
