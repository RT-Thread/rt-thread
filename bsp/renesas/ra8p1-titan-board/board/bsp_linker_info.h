...
#define __itcm_zero$$Base                     Image$$__itcm_zero$$ZI$$Base
#define __itcm_zero$$Limit                    Image$$__itcm_zero$$ZI$$Limit
#define __dtcm_zero$$Base                     Image$$__dtcm_zero$$ZI$$Base
#define __dtcm_zero$$Limit                    Image$$__dtcm_zero$$ZI$$Limit
...
#define __itcm_from_ospi0_cs1$$Base           Image$$__itcm_from_ospi0_cs1$$Base
#define __itcm_from_ospi0_cs1$$Limit          Image$$__itcm_from_ospi0_cs1$$Limit
#define __itcm_from_ospi1_cs1$$Base           Image$$__itcm_from_ospi1_cs1$$Base
#define __itcm_from_ospi1_cs1$$Limit          Image$$__itcm_from_ospi1_cs1$$Limit
#define __itcm_from_data_flash$$Base          Image$$__itcm_from_data_flash$$Base
#define __itcm_from_data_flash$$Limit         Image$$__itcm_from_data_flash$$Limit
#define __itcm_from_flash$$Base               Image$$__itcm_from_flash$$Base
#define __itcm_from_flash$$Limit              Image$$__itcm_from_flash$$Limit
#define __dtcm_from_ospi0_cs1$$Base           Image$$__dtcm_from_ospi0_cs1$$Base
#define __dtcm_from_ospi0_cs1$$Limit          Image$$__dtcm_from_ospi0_cs1$$Limit
#define __dtcm_from_ospi1_cs1$$Base           Image$$__dtcm_from_ospi1_cs1$$Base
#define __dtcm_from_ospi1_cs1$$Limit          Image$$__dtcm_from_ospi1_cs1$$Limit
#define __dtcm_from_data_flash$$Base          Image$$__dtcm_from_data_flash$$Base
#define __dtcm_from_data_flash$$Limit         Image$$__dtcm_from_data_flash$$Limit
#define __dtcm_from_flash$$Base               Image$$__dtcm_from_flash$$Base
#define __dtcm_from_flash$$Limit              Image$$__dtcm_from_flash$$Limit
