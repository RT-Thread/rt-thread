...
void timer_enable(S8 tmr_id, U8 enable)
{
    if(enable)
    {
        if (tmr_id == GD_REG_TIMER1)
        {
            GH_TIMER_set_Control_ClkSel1(0);
            GH_TIMER_set_Control_OF1(1);
            GH_TIMER_set_Control_Enable1(1);
    }
        else if (tmr_id == GD_REG_TIMER2)
        {
            GH_TIMER_set_Control_ClkSel2(0);
            GH_TIMER_set_Control_OF2(1);
            GH_TIMER_set_Control_Enable2(1);
        }
        else
        {
            GH_TIMER_set_Control_ClkSel3(0);
            GH_TIMER_set_Control_OF3(1);
            GH_TIMER_set_Control_Enable3(1);
        }
    }
}
/*
