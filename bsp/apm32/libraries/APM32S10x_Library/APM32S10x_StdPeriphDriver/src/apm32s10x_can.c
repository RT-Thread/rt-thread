...
/*!
 * @brief     Configure the CAN peripheral according to the specified parameters in the filterConfig.
 *
 * @param     can: Select the CAN peripheral which can be CAN1 or CAN2.
 *
...
/*!
 * @brief     Enable the DBG Freeze for CAN.
 *
 * @param     can: Select the CAN peripheral.
 *
 * @retval    None
...
/*!
 * @brief     Initiate the transmission of a message.
 *
 * @param     can: Select the CAN peripheral.
 *
...
/*!
 * @brief     Check the transmission of a message.
 *
 * @param     can: Select the CAN peripheral.
 *
...
/*!
 * @brief     Receive a message and save to a CAN_RxMessage_T structure.
 *
 * @param     can: Select the CAN peripheral.
 *
...
/*!
 * @brief     Release the specified FIFO.
 *
 * @param     can: Select the CAN peripheral.
 *
 * @param     FIFONumber: Receive FIFO number
...
/*!
 * @brief     Clear the CAN's pending flags.
 *
 * @param     can: Select the CAN peripheral.
 *
 * @param     flag: specifies the CAN flag.
...
/*!
 * @brief     Clear the can's interrupt flag.
 *
 * @param     can: Select the CAN peripheral.
 *
