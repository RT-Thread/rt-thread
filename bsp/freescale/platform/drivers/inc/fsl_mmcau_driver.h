 ...
 *  12/19/2013
 */
#ifndef __FSL_MMCAU_DRIVER_H__
#define __FSL_MMCAU_DRIVER_H__
...
/*!
 * @brief SHA1: Performs the hash and generates SHA1 state variables.
 *
 * This function performs the hash and generates SHA1 state variables for one or more input message blocks.
 *
 * @param [in]       *msg_data    pointer to start of input message data
 * @param [in]       num_blks     number of 512‐bit blocks to process
