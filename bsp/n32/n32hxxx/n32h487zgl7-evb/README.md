...
N32H488ZEL7_EVB V1.1 是 Nsing 推出的一款基于 ARM Cortex-M4 内核的开发板，最高主频为 240Mhz，该开发板具有丰富的板载资源，可以充分发挥 N32H488 的芯片性能。
...
- MCU：N32H488ZEL7，主频 240MHz，512KB FLASH ，160KB RAM
- 外部 PSRAM：IS66WV51216EBLL（FEMC）
- 外部 EEROM：AT24C02
- 外部 FLASH：W25Q128JVSIQTR（SPI）、P25Q40HA-SSH-IT（XSPI）、IS34ML01G081-TLI（FEMC-NAND）
- 常用外设
  - LED：3个，LED1（PA3），LED2（PB4），LED3（PA8）
  - 按键：4个，WKUP（兼具唤醒功能，PA0），KEY1（PC13），KEY2（PA15），KEY3（PC8）
