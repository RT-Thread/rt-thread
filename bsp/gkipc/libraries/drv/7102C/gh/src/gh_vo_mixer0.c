...
void GH_VO_MIXER0_init(void)
{
    ...
    GH_VO_MIXER0_set_CONTROL((U32)0x00000000);
    GH_VO_MIXER0_set_ACTIVE_SIZE((U32)0x00000000);
    GH_VO_MIXER0_set_VIDEO_START((U32)0x00000000);
    GH_VO_MIXER0_set_VIDEO_END((U32)0x00000000);
    GH_VO_MIXER0_set_OSD_START((U32)0x00000000);
    GH_VO_MIXER0_set_OSD_END((U32)0x00000000);
    GH_VO_MIXER0_set_BACKGROUND((U32)0x00000000);
    GH_VO_MIXER0_set_HIGHLIGHT((U32)0xff000000);
    GH_VO_MIXER0_set_OSD_CONTROL((U32)0x000000ff);
    GH_VO_MIXER0_set_ENABLE_CTRL((U32)0x00000000);
    GH_VO_MIXER0_set_INPUT_VIDEO_SYNC((U32)0x00000000);
    GH_VO_MIXER0_set_OUTPUT_SYNC((U32)0x00000000);
    GH_VO_MIXER0_set_SMEM_INPUT((U32)0x00000000);
    GH_VO_MIXER0_set_SMEM_OUT((U32)0x00000000);
    GH_VO_MIXER0_set_FRAME_ENABLE((U32)0x00000000);
    GH_VO_MIXER0_set_CLUT_A(0, (U32)0x00000000);
    for (i=1; i<256; i++)
    {
        GH_VO_MIXER0_set_CLUT_A(i, (U32)0x00000000);
    }
