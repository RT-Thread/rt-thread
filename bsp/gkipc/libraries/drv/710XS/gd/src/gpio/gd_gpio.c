...
GERR GD_GPIO_SetType(GD_HANDLE handle, GD_GPIO_TYPE_E type)
{
    ...
    {
        if(ph->number<4)//gpio0-3
        {
            switch(ph->number%4)
            {
            case 0:
                GH_PLL_set_IOCTRL_GPIO_io2((55-ph->number)/4, GD_GPIO_GET_IOCTRL(type));
                break;
            case 1:
                GH_PLL_set_IOCTRL_GPIO_io0((55-ph->number)/4, GD_GPIO_GET_IOCTRL(type));
                break;
            case 2:
                GH_PLL_set_IOCTRL_GPIO_io1((55-ph->number)/4, GD_GPIO_GET_IOCTRL(type));
                break;
            case 3:
                GH_PLL_set_IOCTRL_GPIO_io3((55-ph->number)/4, GD_GPIO_GET_IOCTRL(type));
                break;
            }
        }
        else if(ph->number<52)//gpio4-51
        {
            switch(ph->number%4)
            {
            case 0:
        ...
        else if(ph->number<56)//gpio52-55
        {
            switch(ph->number%4)
            {
            case 0:
