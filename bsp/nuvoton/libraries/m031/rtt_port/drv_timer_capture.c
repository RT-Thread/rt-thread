...
* Change Logs:
* Date            Author           Notes
* 2021-02-08      klcheng          First version
*
******************************************************************************/
...
void timer_interrupt_handler(nu_capture_t *nu_timer_capture)
{
    ...
    {
        TIMER_EnableCapture(nu_timer_capture->timer, TIMER_CAPTURE_COUNTER_RESET_MODE, TIMER_CAPTURE_FALLING_AND_RISING_EDGE);
...
static rt_err_t nu_capture_open(struct rt_inputcapture_device *inputcapture)
{
    ...
    TIMER_EnableCapture(nu_capture->timer, TIMER_CAPTURE_COUNTER_RESET_MODE, TIMER_CAPTURE_RISING_EDGE);
