...
{
    TCAP_START = -1,
#if defined(BSP_USING_ETIMER0_CAPTURE)
    TCAP0_IDX,
#endif
#if defined(BSP_USING_ETIMER1_CAPTURE)
    TCAP1_IDX,
#endif
#if defined(BSP_USING_ETIMER2_CAPTURE)
    TCAP2_IDX,
#endif
#if defined(BSP_USING_ETIMER3_CAPTURE)
    TCAP3_IDX,
#endif
    TCAP_CNT
};
...
static int nu_etimer_capture_device_init(void)
{
    int i;
...
INIT_DEVICE_EXPORT(nu_etimer_capture_device_init);

#endif //#if defined(BSP_USING_ETIMER_CAPTURE)
