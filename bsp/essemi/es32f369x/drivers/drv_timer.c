...
#ifdef BSP_USING_AD16C4T1_CLOCK_TIMER

static struct es32f3_clock_timer_dev ad16c4t1_clock_timer;

static struct rt_clock_timer_info ad16c4t1_info =
{
    ES_SYS_CLK >> ES_CMU_PCLK_1_DIV, /* maximum count frequency */
    (ES_SYS_CLK >> ES_CMU_PCLK_1_DIV)/(1U<<16),        /* minimum count frequency */
    0xFFFF,    /* counter maximum value */
    ES_AD16C4T1_CLOCK_TIMER_MODE
};

void AD16C4T1_UP_Handler(void)
{
    ald_timer_clear_flag_status(ad16c4t1_clock_timer.clock_timer_periph, TIMER_FLAG_UPDATE);
    rt_clock_timer_isr(&ad16c4t1_clock_timer.parent);
}

#endif
#ifdef BSP_USING_GP32C4T0_CLOCK_TIMER

static struct es32f3_clock_timer_dev gp32c4t0_clock_timer;

static struct rt_clock_timer_info gp32c4t0_info =
{

    ES_SYS_CLK >> ES_CMU_PCLK_1_DIV , /* maximum count frequency */
    ( ES_SYS_CLK >> ES_CMU_PCLK_1_DIV )/(1U<<16),        /* minimum count frequency */
    0xFFFFFFFF,    /* counter maximum value */
    ES_GP32C4T0_CLOCK_TIMER_MODE
};

void GP32C4T0_Handler(void)
{
    ald_timer_clear_flag_status(gp32c4t0_clock_timer.clock_timer_periph, TIMER_FLAG_UPDATE);
    rt_clock_timer_isr(&gp32c4t0_clock_timer.parent);
}

#endif
#ifdef BSP_USING_GP32C4T1_CLOCK_TIMER

static struct es32f3_clock_timer_dev gp32c4t1_clock_timer;

static struct rt_clock_timer_info gp32c4t1_info =
{
    (ES_SYS_CLK >> ES_CMU_PCLK_1_DIV ), /* maximum count frequency */
    (ES_SYS_CLK >> ES_CMU_PCLK_1_DIV )/(1U<<16),        /* minimum count frequency */
    0xFFFFFFFF,    /* counter maximum value */
    ES_GP32C4T1_CLOCK_TIMER_MODE
};

void GP32C4T1_Handler(void)
{
    ald_timer_clear_flag_status(gp32c4t1_clock_timer.clock_timer_periph, TIMER_FLAG_UPDATE);
    rt_clock_timer_isr(&gp32c4t1_clock_timer.parent);
}
...
static struct es32f3_clock_timer_dev bs16t1_clock_timer;
...
int rt_hw_clock_timer_init(void)
{
    ...
    ad16c4t0_clock_timer.IRQn = AD16C4T0_UP_IRQn;
...
#ifdef BSP_USING_AD16C4T1_CLOCK_TIMER
    static timer_handle_t ad16c4t1_clock_timer_periph;

    ad16c4t1_clock_timer_periph.perh = AD16C4T1;
    ad16c4t1_clock_timer.IRQn = AD16C4T1_UP_IRQn;

    ad16c4t1_clock_timer_periph.init.prescaler = ES_AD16C4T1_CLOCK_TIMER_PRES - 1;
    ad16c4t1_clock_timer_periph.init.mode = ( ES_AD16C4T1_CLOCK_TIMER_MODE == CLOCK_TIMER_CNTMODE_UP )? TIMER_CNT_MODE_UP : TIMER_CNT_MODE_DOWN;
    ad16c4t1_clock_timer.clock_timer_periph = &ad16c4t1_clock_timer_periph;

    ad16c4t1_clock_timer.parent.info = &ad16c4t1_info;
    ad16c4t1_clock_timer.parent.ops = &es32f3_clock_timer_ops;
    ret = rt_clock_timer_register(&ad16c4t1_clock_timer.parent, ES_DEVICE_NAME_AD16C4T1_CLOCK_TIMER, &ad16c4t1_clock_timer);
#endif

#ifdef BSP_USING_GP32C4T0_CLOCK_TIMER
    static timer_handle_t gp32c4t0_clock_timer_periph;

    gp32c4t0_clock_timer_periph.perh = GP32C4T0;
    gp32c4t0_clock_timer.IRQn = GP32C4T0_IRQn;

    gp32c4t0_clock_timer_periph.init.prescaler = ES_GP32C4T0_CLOCK_TIMER_PRES - 1;
    gp32c4t0_clock_timer_periph.init.mode = ( ES_GP32C4T0_CLOCK_TIMER_MODE == CLOCK_TIMER_CNTMODE_UP )? TIMER_CNT_MODE_UP : TIMER_CNT_MODE_DOWN;
    gp32c4t0_clock_timer.clock_timer_periph = &gp32c4t0_clock_timer_periph;

    gp32c4t0_clock_timer.parent.info = &gp32c4t0_info;
    gp32c4t0_clock_timer.parent.ops = &es32f3_clock_timer_ops;
    ret = rt_clock_timer_register(&gp32c4t0_clock_timer.parent, ES_DEVICE_NAME_GP32C4T0_CLOCK_TIMER, &gp32c4t0_clock_timer);
#endif

#ifdef BSP_USING_GP32C4T1_CLOCK_TIMER
    static timer_handle_t gp32c4t1_clock_timer_periph;

    gp32c4t1_clock_timer_periph.perh = GP32C4T1;
    gp32c4t1_clock_timer.IRQn = GP32C4T1_IRQn;

    gp32c4t1_clock_timer_periph.init.prescaler = ES_GP32C4T1_CLOCK_TIMER_PRES - 1;
    gp32c4t1_clock_timer_periph.init.mode = ( ES_GP32C4T1_CLOCK_TIMER_MODE == CLOCK_TIMER_CNTMODE_UP )? TIMER_CNT_MODE_UP : TIMER_CNT_MODE_DOWN;
    gp32c4t1_clock_timer.clock_timer_periph = &gp32c4t1_clock_timer_periph;

    gp32c4t1_clock_timer.parent.info = &gp32c4t1_info;
    gp32c4t1_clock_timer.parent.ops = &es32f3_clock_timer_ops;
    ret = rt_clock_timer_register(&gp32c4t1_clock_timer.parent, ES_DEVICE_NAME_GP32C4T1_CLOCK_TIMER, &gp32c4t1_clock_timer);
#endif
    ...
    bs16t1_clock_timer.IRQn = BS16T1_IRQn;
    ...
    bs16t1_clock_timer.parent.ops = &es32f3_clock_timer_ops;
