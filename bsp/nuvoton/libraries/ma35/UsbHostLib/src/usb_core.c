...
extern void OHCI0_IRQHandler(int vector, void *param);
extern void OHCI1_IRQHandler(int vector, void *param);
extern void EHCI0_IRQHandler(int vector, void *param);
extern void EHCI1_IRQHandler(int vector, void *param);
...
/**
  * @brief       Initialize MA35D1 USB Host controller and USB stack.
  *
  * @return      None.
  */
void  usbh_core_init()
...
#ifdef ENABLE_OHCI0
    rt_hw_interrupt_install(USBH0_IRQn, OHCI0_IRQHandler, NULL, "ohci0");
    rt_hw_interrupt_umask(USBH0_IRQn);
    ohci0_driver.init();
    rt_kprintf("OHCI0 init done.\n");
#endif

#ifdef ENABLE_EHCI0
    rt_hw_interrupt_install(HSUSBH0_IRQn, EHCI0_IRQHandler, NULL, "ehci0");
    rt_hw_interrupt_umask(HSUSBH0_IRQn);
    ehci0_driver.init();
    rt_kprintf("EHCI0 init done.\n");
#endif

#ifdef ENABLE_OHCI1
    rt_hw_interrupt_install(USBH1_IRQn, OHCI1_IRQHandler, NULL, "ohci1");
    rt_hw_interrupt_umask(USBH1_IRQn);
    ohci1_driver.init();
    rt_kprintf("OHCI1 init done.\n");
#endif

#ifdef ENABLE_EHCI1
    rt_hw_interrupt_install(HSUSBH1_IRQn, EHCI1_IRQHandler, NULL, "ehci1");
    rt_hw_interrupt_umask(HSUSBH1_IRQn);
    ehci1_driver.init();
    rt_kprintf("EHCI1 init done.\n");
#endif
}
