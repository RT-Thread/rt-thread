...
struct rt_i2c_configuration
{
    ...
    rt_uint8_t addr_length;  /**< can be 7 or 10 */
    rt_uint16_t slave_addr;  /**< only used in master mode */
...
struct rt_i2c_bus_device_ops
{
    ...
    rt_err_t (*i2c_bus_control)(struct rt_i2c_bus_device *bus,
                                ...
                                void *args);
    /* only used in hw i2c */
    rt_err_t (*configure)(struct rt_i2c_bus_device *device, struct rt_i2c_configuration *configuration);
};
