...
static void ch32f1_clock_timer_init(struct rt_clock_timer_device *device, rt_uint32_t state)
{
    ...
    if (state)
    {
        ch32f1_tim_clock_init(clock_timer_dev->periph);

        clock_timer_info = ch32f1_clock_timer_info_config_get(clock_timer_dev->periph);

        clk = ch32f1_tim_clock_get(clock_timer_dev->periph);
...
static rt_err_t ch32f1_clock_timer_start(struct rt_clock_timer_device *device, rt_uint32_t cnt, rt_clock_timer_mode_t mode)
{
...
static void ch32f1_clock_timer_stop(struct rt_clock_timer_device *device)
{
    struct clock_timer_device *clock_timer_dev;
...
static rt_uint32_t ch32f1_clock_timer_counter_get(struct rt_clock_timer_device *device)
{
    struct clock_timer_device *clock_timer_dev;
...
static rt_err_t ch32f1_clock_timer_control(struct rt_clock_timer_device *device, rt_uint32_t cmd, void *arg)
{
    struct clock_timer_device *clock_timer_dev;
...
static const struct rt_clock_timer_ops clock_timer_ops =
    {
        ...
        .start = ch32f1_clock_timer_start,
        .stop = ch32f1_clock_timer_stop,
        .count_get = ch32f1_clock_timer_counter_get,
        .control = ch32f1_clock_timer_control,
};
...
#ifdef BSP_USING_TIM1_CLOCK_TIMER
    clock_timer_info = ch32f1_clock_timer_info_config_get(clock_timer_device1.periph);
...
#ifdef BSP_USING_TIM2_CLOCK_TIMER
    clock_timer_info = ch32f1_clock_timer_info_config_get(clock_timer_device2.periph);
...
#ifdef BSP_USING_TIM3_CLOCK_TIMER
    clock_timer_info = ch32f1_clock_timer_info_config_get(clock_timer_device3.periph);
...
#ifdef BSP_USING_TIM4_CLOCK_TIMER
    clock_timer_info = ch32f1_clock_timer_info_config_get(clock_timer_device4.periph);
