...
void GH_USB_init(void)
{
    ...
    GH_USB_set_IntrTxE_L((U8)0x00000000);
    GH_USB_set_IntrTxE_H((U8)0x00000000);
    GH_USB_set_IntrRxE((U16)0x00000000);
    GH_USB_set_IntrRxE_L((U8)0x00000000);
    GH_USB_set_IntrRxE_H((U8)0x00000000);
    ...
    GH_USB_set_TxMaxPL((U8)0x00000000);
    GH_USB_set_TxMaxPH((U8)0x00000000);
    ...
    GH_USB_set_RxMaxPL((U8)0x00000000);
    GH_USB_set_RxMaxPH((U8)0x00000000);
    ...
    for (i=0; i<4; i++)
    {
        GH_USB_set_FIFOs_U32(i, (U32)0x00000000);
    }
