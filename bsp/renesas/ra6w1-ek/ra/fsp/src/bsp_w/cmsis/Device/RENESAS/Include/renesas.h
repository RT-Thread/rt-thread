...
/* =========================================================================================================================== */
  ...
  #include "R7FA8T1AH.h"
   ...
   #include "../../../../../bsp/cmsis/Device/RENESAS/Include/R7KA6B1BG.h"
  #else
   #if __has_include("../../../../../bsp/cmsis/Device/RENESAS/Include/D3108BA.h")
    #include "../../../../../bsp/cmsis/Device/RENESAS/Include/D3108BA.h"
   #else
    #include "../../../../../bsp/cmsis/Device/RENESAS/Include/R7KA6B1BG.h"
   #endif
  #endif
 #elif BSP_MCU_GROUP_RA6W1
  #include "../../../../../bsp/cmsis/Device/RENESAS/Include/R7SA6W1CE.h"
 #elif BSP_MCU_GROUP_RA6W3
  #include "../../../../../bsp/cmsis/Device/RENESAS/Include/R7SA6W3xx.h"
 #elif BSP_MCU_GROUP_RA6B2
  #include "../../../../../bsp/cmsis/Device/RENESAS/Include/D3333.h"
 #elif BSP_MCU_GROUP_RA6U1
  #if defined(BOARD_RA6U1_EK)
   #include "../../../../../bsp/cmsis/Device/RENESAS/Include/R7KA6U1BG.h"
  #endif
 #else
