...
#define ESP8266_SAMPLE_WIFI_SSID "SSID-A"
...
#define BSP_I2C1_SCL_PIN 66
#define BSP_I2C1_SDA_PIN 67
...
#define TC_USING_TC_BOARD
#define TC_BOARD_MODBUS_NUMBER 2

/* gpio */

#define TC_BOARD_GPIO_TC

/* adc */

#define TC_BOARD_ADC_TC
#define TC_BOARD_ADC1_TC "adc1"
#define TC_BOARD_ADC2_TC "adc2"

/* i2c */

#define TC_BOARD_I2C_TC
#define TC_USING_TC_BOARD_I2C "i2c1"
#define TC_BOARD_MPU6050_TC
#define TC_BOARD_PCF8563_TC

/* spi */

#define TC_BOARD_SPI_TC
#define TC_USING_TC_BOARD_SPI "spi_tc"
#define TC_BOARD_SPIFLASH_TC
#define TC_BOARD_MPU9250_TC
#define TC_BOARD_TF_CARD_TC
...
#define RT_SFUD_DEFAULT_SPI_CFG {.mode = RT_SPI_MODE_0 | RT_SPI_MSB,.data_width = 8,.max_hz = 10 * 1000 * 1000,}
