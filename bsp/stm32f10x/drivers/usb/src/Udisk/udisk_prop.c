...
DEVICE_PROP udisk_Device_Property =
{
    MASS_init,
    MASS_Reset,
    MASS_Status_In,
...
USER_STANDARD_REQUESTS udisk_User_Standard_Requests =
{
...
ONE_DESCRIPTOR udisk_Device_Descriptor =
{
    (uint8_t*)MASS_DeviceDescriptor,
    MASS_SIZ_DEVICE_DESC
};

ONE_DESCRIPTOR udisk_Config_Descriptor =
{
    (uint8_t*)MASS_ConfigDescriptor,
    MASS_SIZ_CONFIG_DESC
};

ONE_DESCRIPTOR udisk_String_Descriptor[5] =
{
...
{
    return Standard_GetDescriptorData(Length, &udisk_Device_Descriptor );
}
...
{
    return Standard_GetDescriptorData(Length, &udisk_Config_Descriptor );
}
...
uint8_t *MASS_GetStringDescriptor(uint16_t Length)
{
    ...
    {
        return Standard_GetDescriptorData(Length, &udisk_String_Descriptor[wValue0]);
    }
}
