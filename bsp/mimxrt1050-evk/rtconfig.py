...
if PLATFORM == 'gcc':
    ...
    CFLAGS = DEVICE + ' -g -Wall -D__ASSEMBLY__ -D__FPU_USED -eentry'
    AFLAGS = ' -c' + DEVICE + ' -x assembler-with-cpp -Wa,-mimplicit-it=thumb '
    LFLAGS = DEVICE + ' -lm -lgcc -lc' + '  -nostartfiles -Wl,--gc-sections,-Map=rtthread-rt1050.map,-cref,-u,Reset_Handler -T rt1050_ram.ld'
    ...
    AFLAGS = DEVICE
    LFLAGS = DEVICE + ' --info sizes --info totals --info unused --info veneers --list rtthread-rt1050.map --scatter rt1050_ram.sct'
    ...
    LFLAGS = ' --config device/arm/rt1050_ram.icf'
