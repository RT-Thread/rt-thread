...
/** @brief  Check whether the specified SMBUS interrupt source is enabled or not.
  ...
  */
#define __HAL_SMBUS_GET_IT_SOURCE(__HANDLE__, __INTERRUPT__) ((((__HANDLE__)->Instance->CR1 &                          \
...
#define __HAL_SMBUS_GET_FLAG(__HANDLE__, __FLAG__) (((((__HANDLE__)->Instance->ISR) &                                  \
                                                      ((__FLAG__) & SMBUS_FLAG_MASK)) == ((__FLAG__) &                 \
                                                          SMBUS_FLAG_MASK)) ? SET : RESET)
...
#define SMBUS_RESET_CR1(__HANDLE__)   ((__HANDLE__)->Instance->CR1 &= (uint32_t)~((uint32_t)(I2C_CR1_SMBHEN |          \
                                                                      I2C_CR1_SMBDEN |                                 \
                                                                      I2C_CR1_PECEN)))
#define SMBUS_RESET_CR2(__HANDLE__)   ((__HANDLE__)->Instance->CR2 &= (uint32_t)~((uint32_t)(I2C_CR2_SADD |            \
                                                                      I2C_CR2_HEAD10R |                                \
                                                                      I2C_CR2_NBYTES |                                 \
                                                                      I2C_CR2_RELOAD |                                 \
                                                                      I2C_CR2_RD_WRN)))
