...
# QEMU/RISCV64/C908 VIRT 板级支持包使用说明

中文页 | [English](./README.md)

<!-- TOC -->

- [QEMU/RISCV64/C908 VIRT 板级支持包使用说明](#qemuriscv64c908-virt-板级支持包使用说明)
  - [1. 简介](#1-简介)
  - [2. 构建](#2-构建)
    - [2.1. 安装工具链](#21-安装工具链)
...
RISC-V 是一种开放和免费的指令集体系结构 (ISA)。本工程基于 QEMU 的 RISC-V64 VIRT 平台，移植至 C908 处理器平台。
...
进入 xuantie/virt64/c908 所在 BSP 目录，后面的操作不做另外介绍，默认就在这个目录下。
...
在 `$WORKSPACE/rt-thread/bsp/xuantie/virt64/c908` 路径下会生成内核的二进制文件 `rtthread.bin`。
