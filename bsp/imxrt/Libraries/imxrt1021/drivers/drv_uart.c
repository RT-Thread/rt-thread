  ...
  IOMUXC_SetPinConfig(
      ...
      0x10B0u);                               /* Slew Rate Field: Slow Slew Rate
        ...
        IOMUXC_SetPinMux(
            ...
            0U);
        IOMUXC_SetPinMux(
            IOMUXC_GPIO_AD_B1_09_LPUART2_RX,
            0U);
        IOMUXC_SetPinConfig(
            IOMUXC_GPIO_AD_B1_08_LPUART2_TX,
            0x10B0u);
        ...
        IOMUXC_SetPinMux(
            IOMUXC_GPIO_AD_B0_10_LPUART5_TX,
            0U);
        IOMUXC_SetPinMux(
            IOMUXC_GPIO_AD_B0_11_LPUART5_RX,
            0U);
        IOMUXC_SetPinConfig(
            IOMUXC_GPIO_AD_B0_10_LPUART5_TX,
            0x10B0u);
        ...
        IOMUXC_SetPinMux(
            IOMUXC_GPIO_SD_B1_00_LPUART6_TX,
            0U);
        IOMUXC_SetPinMux(
            IOMUXC_GPIO_SD_B1_01_LPUART6_RX,
            0U);
        IOMUXC_SetPinConfig(
            IOMUXC_GPIO_SD_B1_00_LPUART6_TX,
            0x10B0u);
        ...
        IOMUXC_SetPinMux(
            IOMUXC_GPIO_SD_B1_02_LPUART8_TX,
            0U);
        IOMUXC_SetPinMux(
            IOMUXC_GPIO_SD_B1_03_LPUART8_RX,
            0U);
        IOMUXC_SetPinConfig(
            IOMUXC_GPIO_SD_B1_02_LPUART8_TX,
            0x10B0u);
