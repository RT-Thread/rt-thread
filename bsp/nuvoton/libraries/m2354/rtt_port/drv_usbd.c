...
static struct ep_id _ep_pool[] =
{
    ...
    {EPADR_HW2SW(EP8),  USB_ENDPOINT_XFER_INT,         USB_DIR_IN,     EP8_MAX_PKT_SIZE, ID_UNASSIGNED},
    {EPADR_HW2SW(EP9),  USB_ENDPOINT_XFER_INT,         USB_DIR_OUT,    EP9_MAX_PKT_SIZE, ID_UNASSIGNED},
    {EPADR_HW2SW(EP10), USB_ENDPOINT_XFER_BULK,        USB_DIR_IN,     EP6_MAX_PKT_SIZE, ID_UNASSIGNED},
    {EPADR_HW2SW(EP11), USB_ENDPOINT_XFER_BULK,        USB_DIR_OUT,    EP7_MAX_PKT_SIZE, ID_UNASSIGNED},
