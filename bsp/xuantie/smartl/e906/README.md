...
- 当前BSP默认设置的内核是e906fd，该架构支持[F][D][P]扩展，可以通过menuconfig工具使能[F]、[D]、[P]扩展。
...
```shell
qemu-system-riscv32 -machine smartl -nographic -kernel rtthread.elf -cpu e906fdp -gdb tcp::23333 -S
```
