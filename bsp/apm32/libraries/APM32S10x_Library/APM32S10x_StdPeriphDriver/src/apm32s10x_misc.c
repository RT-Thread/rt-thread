...
/*!
 * @brief     Configure the priority grouping: pre-emption priority and subpriority.
 *
 * @param     priorityGroup : specify the priority grouping bits length.
 ...
 *            For the complete APM32 Devices IRQ Channels list,please refer to apm32s10x.h file
 *
...
/*!
 * @brief     Configure the vector table location and Offset.
 *
 * @param     vectTab: specify whether the vector table is in RAM or FLASH memory
 *              This parameter can be one of the following values:
 ...
 *
 * @param     clkSource: specify the SysTick clock source
 *              This parameter can be one of the following values:
