...
if PLATFORM == 'gcc':
    ...
    LFLAGS = DEVICE + ' -specs=nano.specs -specs=nosys.specs -Wl,--defsym=__heap_size__=0x10000,-Map=rtthread.map,--print-memory-usage -Tboard/linker_scripts/LPC55S28_flash.ld'
    ...
    AFLAGS = DEVICE
    LFLAGS = DEVICE + ' --libpath "' + EXEC_PATH + '/ARM/ARMCC/lib" --info sizes --info totals --info unused --info veneers --list rtthread.map --scatter "./LPC55S28_flash.scf" '
    ...
    LFLAGS = ' --config "board/linker_scripts/LPC55S28_flash.icf"'
