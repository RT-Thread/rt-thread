 ...
 * @defgroup BOARD_RRQ61XXX_EVB_LEDS Board LEDs
 * @brief LED information for this board.
 *
 * This is code specific to the RRQ61XXX EVB. It includes info on the number of LEDs and which pins they are on.
 *
 * @{
 **********************************************************************************************************************/
...
/** @} (end defgroup BOARD_RRQ61XXX_EVB_LEDS) */
