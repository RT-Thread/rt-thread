...
#define PKG_USING_STM32WL_HAL_DRIVER
#define PKG_USING_STM32WL_HAL_DRIVER_LATEST_VERSION
#define PKG_USING_STM32WL_CMSIS_DRIVER
#define PKG_USING_STM32WL_CMSIS_DRIVER_LATEST_VERSION
