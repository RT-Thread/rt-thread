...
enum
{
    ...
    kStatus_NBOOT_IskCertUserDataTooBig = 0x5A5AA5EAU,    /*!< Size of User data in ISK certificate is greater than 96 bytes */
    kStatus_NBOOT_IskCertSignatureOffsetTooSmall = 0x5A5AA5EBU,    /*!< Signature offset in ISK certificate is smaller than expected */
