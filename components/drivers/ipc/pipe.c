...
static ssize_t pipe_fops_read(struct dfs_file *fd, void *buf, size_t count, dfs_off_t *pos)
#else
 ...
 */
#ifdef RT_USING_DFS_V2
static ssize_t pipe_fops_write(struct dfs_file *fd, const void *buf, size_t count, dfs_off_t *pos)
#else
