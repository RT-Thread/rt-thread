...
extern DEVICE_PROP udisk_Device_Property;
extern  USER_STANDARD_REQUESTS udisk_User_Standard_Requests;
extern  DEVICE  udisk_Device_Table;
extern DEVICE_INFO udisk_Device_Info;
