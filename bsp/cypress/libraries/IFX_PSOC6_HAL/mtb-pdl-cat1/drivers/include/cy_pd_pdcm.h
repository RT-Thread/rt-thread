...
* \version 5.70
*
* This file provides the header for PDCM driver.
*
********************************************************************************
* \copyright
...
*
* \note  PDCM API's are used by the Syspm driver and BTSS API's, there is no
* need to call them drirectly in Application code.
*
* \section group_pd_pdcm_more_information More Information
*
* For more information on the PDCM, refer to the datasheet of your device.
*
* \defgroup group_pd_pdcm_macros Macros
* \defgroup group_pd_pdcm_functions Functions
* \defgroup group_pd_pdcm_data_structures Data Structures
* \defgroup group_pd_pdcm_enums Enumerated Types
*/
/** \} group_pd_pdcm */
...
/**
* \addtogroup group_pd_pdcm_enums
* \{
*/
...
/**
* \addtogroup group_pd_pdcm_macros
* \{
*/
...
#define CY_SYSPM_IS_PDCM_ID_VALID(id)    (((id) == CY_PD_PDCM_MAIN)     || \
                                           ...
                                           ((id) == CY_PD_PDCM_CPUSS)   || \
                                           ((id) == CY_PD_PDCM_BTSS))
/** \} group_pd_pdcm_macros */

/**
* \addtogroup group_pd_pdcm_functions
* \{
*/
