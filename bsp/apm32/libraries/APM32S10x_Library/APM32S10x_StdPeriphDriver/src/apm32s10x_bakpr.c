...
/*!
 * @brief      Enable the Tamper Pin activation.
 *
 * @param      None
 *
 * @retval     None
...
/*!
 * @brief      Disable the Tamper Pin activation.
 *
 * @param      None
 *
 * @retval     None
 ...
 *                        This parameter can be BAKPR_DATAx where x is between 1 and 10.
 *
...
/*!
 * @brief      Read user data from the specified Data Backup Register.
 *
 * @param      bakrData : specifies the Data Backup Register.
 *                        This parameter can be BAKPR_DATAx where x is between 1 and 10.
 *
...
/*!
 * @brief      Clear Tamper Pin Event pending flag.
 *
 * @param      None
 *
 * @retval     None
...
/*!
 * @brief      Clear Tamper Pin Interrupt pending bit.
 *
 * @param      None
 *
 * @retval     None
