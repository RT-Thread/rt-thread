...
can_bit_timing_cfg_t g_can0_bit_timing_cfg =
{
    /* Actual bitrate: 500000 Hz. Actual Bit Time Ratio: 75 %. */  .baud_rate_prescaler = 1 +1 /* Division value of baud rate prescaler */, .time_segment_1 = 8, .time_segment_2 = 3, .synchronization_jump_width = 3,
};
#endif
...
const dac_extended_cfg_t g_dac0_ext_cfg =
{
    ...
    .ref_volt_sel             = (dac_ref_volt_sel_t) DAC_VREF_AVCC0_AVSS0
};
...
const iic_master_extended_cfg_t g_i2c_master0_extend =
{
    ...
    .smbus_operation         = 0,
    /* Actual calculated bitrate: 99272. Actual calculated duty cycle: 49%. */ .clock_settings.brl_value = 27, .clock_settings.brh_value = 26, .clock_settings.cks_value = 2, .clock_settings.sddl_value = 0, .clock_settings.dlcs_value = 0,
};
