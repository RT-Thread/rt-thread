 ...
 * Change Logs:
 * Date           Author       Notes
 * 2026-05-27     wdfk-prog    add stm32h7rs adc v2 configuration
 */

/**
 * @file adc_config_v2.h
 * @brief STM32H7RS ADC V2 configuration defaults.
 */
...
/** @brief Default ADC clock prescaler for STM32H7RS. */
...
/** @brief Default ADC data alignment for STM32H7RS. */
...
/** @brief Default ADC resolution for STM32H7RS. */
...
/** @brief Default ADC sampling time for STM32H7RS. */
...
/** @brief Maximum regular sequence length supported by the STM32H7RS driver. */
...
/** @brief Default STM32H7RS ADC1 V2 object initializer. */
...
/** @brief Default STM32H7RS ADC2 V2 object initializer. */
...
/** @brief Default STM32H7RS ADC3 V2 object initializer. */
