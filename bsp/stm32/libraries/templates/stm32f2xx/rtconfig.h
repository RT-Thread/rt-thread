...
#define PKG_USING_STM32F2_HAL_DRIVER
#define PKG_USING_STM32F2_HAL_DRIVER_LATEST_VERSION
#define PKG_USING_STM32F2_CMSIS_DRIVER
#define PKG_USING_STM32F2_CMSIS_DRIVER_LATEST_VERSION
