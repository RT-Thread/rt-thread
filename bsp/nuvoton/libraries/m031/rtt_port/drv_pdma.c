...
static const nu_pdma_periph_ctl_t g_nu_pdma_peripheral_ctl_pool[ ] =
{
    ...
    { PDMA_PWM0_P1_RX, eMemCtl_SrcFix_DstInc },
    { PDMA_PWM0_P2_RX, eMemCtl_SrcFix_DstInc },
    { PDMA_PWM0_P3_RX, eMemCtl_SrcFix_DstInc },
    { PDMA_PWM1_P1_RX, eMemCtl_SrcFix_DstInc },
    { PDMA_PWM1_P2_RX, eMemCtl_SrcFix_DstInc },
    { PDMA_PWM1_P3_RX, eMemCtl_SrcFix_DstInc },
...
static void nu_pdma_memfun_actor_init(void)
{
    ...
    for (i = 0; i < NU_PDMA_MEMFUN_ACTOR_MAX; i++)
    {
        ...
        {
            nu_pdma_memfun_actor_arr[i].m_psSemMemFun = rt_sem_create("memactor_sem", 0, RT_IPC_FLAG_PRIO);
    ...
    if (i)
    {
        ...
        nu_pdma_memfun_actor_pool_sem = rt_sem_create("mempool_sem", nu_pdma_memfun_actor_maxnum, RT_IPC_FLAG_PRIO);
