...
- 当前BSP默认设置的内核是r908fdv，该架构支持[F][D][V]扩展，可以通过menuconfig工具使能[F][D]、[V]扩展。
...
```shell
qemu-system-riscv64 -machine xiaohui -smp cpus=2 -nographic -kernel rtthread.elf -cpu r908fdv
```
