 ...
 * T_HSTRAIL_D0 (RW)
 *
 * the number of byteclk cycles that the datalane0 stay at hs-trail state during a hs clock trasmission
 */
 ...
 * T_HSEXIT_D0 (RW)
 *
 * the number of byteclk cycles that the datalane0 stay at state hs-exit sate after a hs clock trasmission
 */
 ...
 * T_HSTRAIL_D1 (RW)
 *
 * the number of byteclk cycles that the datalane1 stay at hs-trail state during a hs clock trasmission
 */
 ...
 * T_HSEXIT_D1 (RW)
 *
 * the number of byteclk cycles that the datalane1 stay at state hs-exit sate after a hs clock trasmission
 */
 ...
 * T_HSTRAIL_D2 (RW)
 *
 * the number of byteclk cycles that the datalane2 stay at hs-trail state during a hs clock trasmission
 */
 ...
 * T_HSEXIT_D2 (RW)
 *
 * the number of byteclk cycles that the datalane2 stay at state hs-exit sate after a hs clock trasmission
 */
 ...
 * T_HSTRAIL_D3 (RW)
 *
 * the number of byteclk cycles that the datalane3 stay at hs-trail state during a hs clock trasmission
 */
 ...
 * T_HSEXIT_D3 (RW)
 *
 * the number of byteclk cycles that the datalane3 stay at state hs-exit sate after a hs clock trasmission
 */
 ...
 * REFCLK_DIV (RW)
 *
 * input refrence clock divider ratio control
 */
