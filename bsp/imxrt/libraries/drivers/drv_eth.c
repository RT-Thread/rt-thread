...
#define RING_ID 0
typedef uint8_t rx_buffer_t[RT_ALIGN_UP(ENET_TXBUFF_SIZE, ENET_BUFF_ALIGNMENT)];
typedef uint8_t tx_buffer_t[RT_ALIGN_UP(ENET_TXBUFF_SIZE, ENET_BUFF_ALIGNMENT)];
...
rt_uint8_t g_txDataBuff[ENET_TXBD_NUM][RT_ALIGN_UP(ENET_TXBUFF_SIZE, ENET_BUFF_ALIGNMENT)];

AT_NONCACHEABLE_SECTION_ALIGN(static enet_rx_bd_struct_t g_rxBuffDescrip[ENET_RXBD_NUM], ENET_BUFF_ALIGNMENT);
ALIGN(ENET_BUFF_ALIGNMENT)
rt_uint8_t g_rxDataBuff[ENET_RXBD_NUM][RT_ALIGN_UP(ENET_RXBUFF_SIZE, ENET_BUFF_ALIGNMENT)];
