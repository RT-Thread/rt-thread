# QEMU/RISCV64/C908 VIRT Board Support Package User Guide

English | [中文](./README_cn.md)

<!-- TOC -->

- [QEMU/RISCV64/C908 VIRT Board Support Package User Guide](#qemuriscv64c908-virt-board-support-package-user-guide)
...
RISC-V is an open and free instruction set architecture (ISA). This project is based on QEMU's RISC-V64 VIRT platform, ported to the C908 processor platform.
...
Enter xuantie/virt64/c908 the location of the BSP directory, the latter operation is not otherwise described, the default is in this directory.

```shell
cd $WORKSPACE/rt-thread/bsp/xuantie/virt64/c908
```
...
The kernel binary file `rtthread.bin` will be generated in the `$WORKSPACE/rt-thread/bsp/xuantie/virt64/c908`.
