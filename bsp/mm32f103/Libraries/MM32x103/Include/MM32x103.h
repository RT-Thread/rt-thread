...
*        definitions and memory mapping for mm32x103 High Density, Medium 
...
/*!< [31:16] mm32x103 Standard Peripheral Library main version */
#define __MM32x103_STDPERIPH_VERSION_MAIN   (0x01)                                  
/*!< [15:8]  mm32x103 Standard Peripheral Library sub1 version */
#define __MM32x103_STDPERIPH_VERSION_SUB1   (0x00)
/*!< [7:0]  mm32x103 Standard Peripheral Library sub2 version */
#define __MM32x103_STDPERIPH_VERSION_SUB2   (0x00) 
/*!< mm32x103 Standard Peripheral Library version number */
#define __MM32x103_STDPERIPH_VERSION       ((__MM32x103_STDPERIPH_VERSION_MAIN << 16)\
| (__MM32x103_STDPERIPH_VERSION_SUB1 << 8)\
  | __MM32x103_STDPERIPH_VERSION_SUB2)
...
*/
#define __MPU_PRESENT             0 /*!< mm32x103 does not provide a MPU present or not  */
#define __NVIC_PRIO_BITS          4 /*!< mm32x103 uses 4 Bits for the Priority Levels    */
...
typedef enum IRQn
{
  ...
  /******  mm32x103 CM3 specific Interrupt Numbers *********************************************************/
...
/*!< mm32x103 Standard Peripheral Library old types (maintained for legacy prupose) */
typedef int32_t  s32;
typedef int16_t s16;
typedef int8_t  s8;
