...
#ifndef CY8C6244LQI_S4D92
    #error "Unexpected MPN; expected DEVICE:=CY8C6244LQI-S4D92. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif
#endif
