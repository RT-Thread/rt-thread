...
*                      the "startup_MM32x103_xx.s" file.
*
...
*    Then SystemInit() function is called, in "startup_MM32x103_xx.s" file, to
...
*    the product used), refer to "HSE_VALUE" define in "MM32x103.h" file. 
