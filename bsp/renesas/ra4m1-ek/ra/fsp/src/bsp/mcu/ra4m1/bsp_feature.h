...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS                           (0x03FF7FFFUL)    // Mask of available channels in ADC unit 0.
...
#define BSP_FEATURE_BSP_HAS_SCE5                                  (1UL)             // Indicates the SCE5 crypto engine is available.
...
#define BSP_FEATURE_BSP_HAS_USB_CLOCK_SEL_ALT                     (1UL)             // Indicates the USBCKCR_ALT register should be used instead of USBCKCR.
...
#define BSP_FEATURE_BSP_MSTP_GPT_MSTPD5_MAX_CH                    (1UL)             // Largest channel number associated with GPT on the MSTPCRD.MSTPD5 field on this MCU.
...
#define BSP_FEATURE_DMAC_MAX_CHANNEL                              (4UL)             // Number of DMAC channels available.
...
#define BSP_FEATURE_SCI_ADDRESS_MATCH_CHANNELS                    (0x0207UL)        // Mask of channels with data compare match (DCCR) available.
#define BSP_FEATURE_SCI_CHANNELS                                  (0x0207UL)        // Mask of available SCI channels.
...
#define BSP_FEATURE_SCI_UART_FIFO_CHANNELS                        (0x03UL)          // Mask of channels which support the UART FIFO.
