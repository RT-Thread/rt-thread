...
| IIC          |     支持     | 硬件I2C1, 软件IIC, 如需使用该外设，请使用 Cube 重新配                         |
| SPI          |     支持     | SPI1, 如需使用该外设，请使用 Cube 重新配                                     |
| RTC          |     支持     | RTC, 如需使用该外设，请使用 Cube 重新配                                      |
| ADC          |     支持     | ADC1/2/3, 如需使用该外设，请使用 Cube 重新配                                 |
| WDG          |     支持     | IWDG, 如需使用该外设，请使用 Cube 重新配                                     |
| FLASH        |     支持     | ON CHIP XSPI FLASH, 如需使用该外设，请使用 Cube 重新配                       |
| FDCAN        |     支持     | FDCAN1..8, 如需使用该外设，请使用 Cube 重新配                                |
| DAC          |     支持     | DAC1/2, 如需使用该外设，请使用 Cube 重新配                                   |
| TIMER        |     支持     | ATIM1..4, GTIMA1..7, GTIMB1..3, BTIM1..4, 如需使用该外设，请使用 Cube 重新配 |
| PWM          |     支持     | PWM1..14, 如需使用该外设，请使用 Cube 重新配                                 |
| ENCODER      |     支持     | PULSE ENCODER1..14, 如需使用该外设，请使用 Cube 重新配                       |
| LPTIM        |     支持     | LPTIM1..5, 如需使用该外设，请使用 Cube 重新配                                |
| NAND         |     支持     | FEMC NAND1..2, 如需使用该外设，请使用 Cube 重新配                            |
| ETH          |     支持     | ETH1..2, 如需使用该外设，请使用 Cube 重新配                                  |
