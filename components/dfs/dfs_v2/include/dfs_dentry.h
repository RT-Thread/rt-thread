...
struct dfs_dentry
{
    ...
    uint32_t flags;             //目录项的flags protect by d_lock

#define DENTRY_IS_MOUNTED   0x1 // dentry 被当做挂载点
#define DENTRY_IS_ALLOCED   0x2 // dentry 申请成功
#define DENTRY_IS_ADDHASH   0x4 // dentry 添加hash成功
#define DENTRY_IS_OPENED    0x8 // dentry 对应的文件打开成功
    char *pathname;           // the pathname under mounted file system
