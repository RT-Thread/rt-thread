...
rt_err_t adc_demo_run(void)
{
    ...
    adc_sync_set_resolution(&ADC_0,  ADC_CTRLC_RESSEL_8BIT_Val);
    adc_sync_enable_channel(&ADC_0,  0);
#ifndef RT_USING_FINSH
    rt_kprintf("buf[0]=0x%02X buf[1]=0x%02X\r\n", buffer[0], buffer[1]);
#endif
    ...
    adc_sync_disable_channel(&ADC_0, 0);
    adc_sync_set_resolution(&ADC_0,  ADC_CTRLC_RESSEL_10BIT_Val);
    adc_sync_enable_channel(&ADC_0,  0);
#ifndef RT_USING_FINSH
    rt_kprintf("buf[0]=0x%02X buf[1]=0x%02X\r\n", buffer[0], buffer[1]);
#endif
    ...
    adc_sync_disable_channel(&ADC_0, 0);
    adc_sync_set_resolution(&ADC_0,  ADC_CTRLC_RESSEL_12BIT_Val);
    adc_sync_enable_channel(&ADC_0,  0);
#ifndef RT_USING_FINSH
    rt_kprintf("buf[0]=0x%02X buf[1]=0x%02X\r\n", buffer[0], buffer[1]);
#endif
    ...
    adc_sync_disable_channel(&ADC_0, 0);
    adc_sync_set_resolution(&ADC_0,  ADC_CTRLC_RESSEL_16BIT_Val);
    adc_sync_enable_channel(&ADC_0,  0);
#ifndef RT_USING_FINSH
    rt_kprintf("buf[0]=0x%02X buf[1]=0x%02X\r\n", buffer[0], buffer[1]);
#endif
