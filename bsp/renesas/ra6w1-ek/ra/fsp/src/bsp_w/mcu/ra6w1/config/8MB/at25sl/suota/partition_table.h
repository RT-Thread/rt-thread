 ...
 ****************************************************************************************
 *
 * @file 8MB/at25sl/suota/partition_table.h
 *
...
/* START suota_8MB_flash_partition_table for AT25SL series */
...
#define NVMS_FW_EXEC_PART_START           SF_RTOS_0
...
#define NVMS_FW_UPDATE_PART_START         SF_RTOS_1
...
PARTITION2(NVMS_LOG_PART, 0)                               // TLS certificates
PARTITION2(NVMS_FW_UPDATE_PART, 0)                         // RTOS #1
PARTITION2(NVMS_BIN_PART, 0)                               // User Area
