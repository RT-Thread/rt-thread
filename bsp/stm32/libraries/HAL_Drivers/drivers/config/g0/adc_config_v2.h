 ...
 * Change Logs:
 * Date           Author       Notes
 * 2026-05-27     wdfk-prog    add stm32g0 adc v2 configuration
 */

/**
 * @file adc_config_v2.h
 * @brief STM32G0 ADC V2 configuration defaults.
 */
...
/** @brief Default ADC clock prescaler for STM32G0. */
...
/** @brief Default ADC data alignment for STM32G0. */
...
/** @brief Default ADC resolution for STM32G0. */
...
/** @brief Default ADC sampling time for STM32G0. */
...
/** @brief Maximum regular sequence length supported by the STM32G0 driver. */
...
/** @brief Default STM32G0 ADC1 V2 object initializer. */
