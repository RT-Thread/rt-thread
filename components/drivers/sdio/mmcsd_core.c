...
/**
 * fls - find first bit set in a word.
 * @x: the word to search
 *
 * This is defined the same way as ffs.
 * Note fls(0) = 0, fls(1) = 1, fls(0x20000008) = 4.
 */
rt_inline rt_uint32_t _ffs(rt_uint32_t x)
{
    int r = 1;
 ...
 *
 * This is defined the same way as ffs.
 * Note fls(0) = 0, fls(1) = 1, fls(0x20000008) = 30.
 */
rt_inline rt_uint32_t _fls(rt_uint32_t val)
{
    rt_uint32_t  bit = 32;
