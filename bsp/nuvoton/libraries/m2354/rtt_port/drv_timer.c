...
int rt_hw_timer_init(void)
{
    ...
    ret = rt_clock_timer_register(&nu_timer4.parent, "timer4", &nu_timer4);
    if (ret != RT_EOK)
    {
    ...
    ret = rt_clock_timer_register(&nu_timer5.parent, "timer5", &nu_timer5);
    if (ret != RT_EOK)
    {
...
void TMR4_IRQHandler(void)
{
    ...
    if (TIMER_GetIntFlag(TIMER4))
    {
        ...
        rt_clock_timer_isr(&nu_timer4.parent);
    }
...
void TMR5_IRQHandler(void)
{
    ...
    if (TIMER_GetIntFlag(TIMER5))
    {
        ...
        rt_clock_timer_isr(&nu_timer5.parent);
    }
