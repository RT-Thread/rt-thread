# AT32M416 AT-START 开发板 BSP 说明

## 简介

AT32M416 AT-START是雅特力推出的一款AT32M416系列的评估板，其搭载的MCU主要资源参数如下：
...
AT32M416-START板级包支持MDK4﹑MDK5﹑IAR开发环境和GCC编译器，以下是具体版本信息：
...
- MCU：AT32M416CBT7，主频 180MHz，128KB FLASH ，16KB RAM
- 常用外设
  - LED：3个，（红色PF6、黄色PF7、绿色PF8）
