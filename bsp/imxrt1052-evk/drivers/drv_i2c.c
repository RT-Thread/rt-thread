...
#define LPI2C_CLOCK_SOURCE_DIVIDER (4U)
...
#ifdef RT_USING_LPI2C1
static struct rt1052_i2c_bus lpi2c1 =
{
    .I2C = LPI2C1,
    .device_name = I2C1BUS_NAME,
};
#endif /* RT_USING_LPI2C1 */
#ifdef RT_USING_LPI2C2
...
static rt_err_t imxrt_lpi2c_configure(struct rt1052_i2c_bus *bus, lpi2c_master_config_t *cfg)
{
    ...
    rt_event_init(&bus->ev, bus->device_name, RT_IPC_FLAG_FIFO);
    return RT_EOK;
}
...
int rt_hw_i2c_init(void)
{
    ...
    /* register I2C1: SCL/P0_20 SDA/P0_19 */
    {
        ...
        IOMUXC_SetPinConfig(IOMUXC_GPIO_B0_04_GPIO2_IO04,
                            0xD8B0u);
        IOMUXC_SetPinMux(IOMUXC_GPIO_B0_05_GPIO2_IO05, 1U);
        IOMUXC_SetPinConfig(IOMUXC_GPIO_B0_05_GPIO2_IO05,
                            0xD8B0u);
        ...
        IOMUXC_SetPinConfig(IOMUXC_GPIO_EMC_12_GPIO4_IO12,
                            0xD8B0u);
        IOMUXC_SetPinMux(IOMUXC_GPIO_EMC_11_GPIO4_IO11, 1U);
        IOMUXC_SetPinConfig(IOMUXC_GPIO_EMC_11_GPIO4_IO11,
                            0xD8B0u);
