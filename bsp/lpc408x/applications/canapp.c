...
struct rt_can_filter_item filter1item[] =
{
    ...
    LPC_CAN_AF_EXT_INIT(5, lpccanind, RT_NULL),
    LPC_CAN_AF_EXT_INIT(1, lpccanind, RT_NULL),
    LPC_CAN_AF_EXT_GRP_INIT(6, 7, lpccanind, RT_NULL),
    LPC_CAN_AF_EXT_GRP_INIT(10, 11, lpccanind, RT_NULL),
    LPC_CAN_AF_EXT_GRP_INIT(8, 9, lpccanind, RT_NULL),
    LPC_CAN_AF_STD_INIT(1, lpccanind, RT_NULL),
    LPC_CAN_AF_STD_INIT(3, lpccanind, RT_NULL),
    LPC_CAN_AF_STD_INIT(4, lpccanind, RT_NULL),
    LPC_CAN_AF_STD_INIT(5, lpccanind, RT_NULL),
    LPC_CAN_AF_STD_INIT(2, lpccanind, RT_NULL),
    LPC_CAN_AF_EXT_INIT(2, lpccanind, RT_NULL),
    LPC_CAN_AF_EXT_INIT(3, lpccanind, RT_NULL),
