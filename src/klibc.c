 ...
 * Change Logs:
 * Date           Author       Notes
 * 2022-11-14     Meco Man     the first version
 */
...
static volatile int __rt_errno; /* global errno in RT-Thread */
 ...
 *
 * @note   don't support float number format.
 *
...
void rt_kputs(const char *str)
{
    ...
    {
        rt_device_write(console_device, 0, str, rt_strlen(str));
    }
#else
    rt_hw_console_output(str);
