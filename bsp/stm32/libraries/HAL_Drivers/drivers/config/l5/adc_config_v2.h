 ...
 * Change Logs:
 * Date           Author       Notes
 * 2026-05-27     wdfk-prog    add stm32l5 adc v2 configuration
 */

/**
 * @file adc_config_v2.h
 * @brief STM32L5 ADC V2 configuration defaults.
 */
...
/** @brief Default ADC clock prescaler for STM32L5. */
...
/** @brief Default ADC data alignment for STM32L5. */
...
/** @brief Default ADC resolution for STM32L5. */
...
/** @brief Default ADC sampling time for STM32L5. */
...
/** @brief Maximum regular sequence length supported by the STM32L5 driver. */
...
/** @brief Default STM32L5 ADC1 V2 object initializer. */
...
/** @brief Default STM32L5 ADC2 V2 object initializer. */
