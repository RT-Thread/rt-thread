 ...
 * Change Logs:
 * Date           Author       Notes
 * 2026-04-21     wdfk-prog    add stm32mp1 adc v2 configuration
 */

/**
 * @file adc_config_v2.h
 * @brief STM32MP1 ADC V2 configuration defaults.
 */
...
/** @brief Default ADC clock prescaler for STM32MP1. */
...
/** @brief Default ADC data alignment for STM32MP1. */
...
/** @brief Default ADC sampling time for STM32MP1. */
...
/** @brief Maximum regular sequence length supported by the STM32MP1 driver. */
...
/** @brief STM32MP1 VBAT HAL ADC channel for the ADC2 route. */
#define STM32_ADC_VBAT_HAL_CHANNEL ADC_CHANNEL_VBAT
/** @brief STM32MP1 ADC instances that can sample VBAT. */
#define STM32_ADC_VBAT_INSTANCE_MASK (1UL << 1)
#endif /* defined(ADC_CHANNEL_VBAT) */

#if defined(ADC_CHANNEL_VREFINT)
/** @brief STM32MP1 VREFINT HAL ADC channel for the ADC2 route. */
#define STM32_ADC_VREF_HAL_CHANNEL ADC_CHANNEL_VREFINT
/** @brief STM32MP1 ADC instances that can sample VREFINT. */
#define STM32_ADC_VREF_INSTANCE_MASK (1UL << 1)
...
/** @brief Default STM32MP1 ADC1 V2 object initializer. */
...
/** @brief Default STM32MP1 ADC2 V2 object initializer. */
...
/** @brief Default STM32MP1 ADC3 V2 object initializer. */
