...
本文档为 RT-Thread 开发团队为 STM32F302-Nucleo-64 开发板提供的 BSP (板级支持包) 说明。
...
- 常用外设
  - LED：3 个，LD1, LD2, LD3。
  - 按键，2 个，B1(USER),B2(RESET)。
- 调试接口，板载 ST-LINK/V2-1 调试器。

开发板更多详细信息请参考意法半导体 [STM32F302-Nucleo-64 开发板介绍](https://www.st.com/en/evaluation-tools/nucleo-f302r8.html)。
...
USB 虚拟 COM 端口默认连接串口 2，在终端工具里打开相应的串口，复位设备后，可以看到 RT-Thread 的输出信息:
...
- [Mr.Tiger](https://github.com/MrYangMouren/rt-thread)，邮箱：<1039241323@qq.com>
