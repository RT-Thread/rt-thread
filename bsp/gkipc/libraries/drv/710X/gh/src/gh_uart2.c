...
/* registers                                                                  */
/*----------------------------------------------------------------------------*/
#define REG_UART2_RBR_REAL                                  FIO_ADDRESS(UART2,0x7001E000) /* read */
#define REG_UART2_THR_REAL                                  FIO_ADDRESS(UART2,0x7001E000) /* write */
#define REG_UART2_DLL_REAL                                  FIO_ADDRESS(UART2,0x7001E000) /* read/write */
#define REG_UART2_IER_REAL                                  FIO_ADDRESS(UART2,0x7001E004) /* read/write */
#define REG_UART2_DLH_REAL                                  FIO_ADDRESS(UART2,0x7001E004) /* read/write */
#define REG_UART2_IIR_REAL                                  FIO_ADDRESS(UART2,0x7001E008) /* read */
#define REG_UART2_FCR_REAL                                  FIO_ADDRESS(UART2,0x7001E008) /* write */
#define REG_UART2_LCR_REAL                                  FIO_ADDRESS(UART2,0x7001E00C) /* read/write */
#define REG_UART2_MCR_REAL                                  FIO_ADDRESS(UART2,0x7001E010) /* read/write */
#define REG_UART2_LSR_REAL                                  FIO_ADDRESS(UART2,0x7001E014) /* read */
#define REG_UART2_MSR_REAL                                  FIO_ADDRESS(UART2,0x7001E018) /* read */
#define REG_UART2_SCR_REAL                                  FIO_ADDRESS(UART2,0x7001E01C) /* read/write */
...
/* mirror variables                                                           */
/*----------------------------------------------------------------------------*/
GH_UART2_THR_S                          m_uart2_thr;
GH_UART2_FCR_S                          m_uart2_fcr;
...
{
    GH_UART2_RBR_REAL_S real;
    GH_UART2_RBR_S dummy;
     dummy.all =  0;
     real.all = (*(volatile U32 *)REG_UART2_RBR_REAL);
...
{
    GH_UART2_RBR_REAL_S tmp_value;
    U32 value = (*(volatile U32 *)REG_UART2_RBR_REAL);
...
GH_INLINE void GH_UART2_set_THR(U32 data)
{
    ...
    GH_UART2_THR_REAL_S real;
    GH_UART2_THR_S dummy;
    dummy.all = data ;
    real.bitc.data = dummy.bitc.data;
    *(volatile U32 *)REG_UART2_THR_REAL = real.all;
}
...
GH_INLINE void GH_UART2_set_THR_Data(U8 data)
{
    ...
    GH_UART2_THR_REAL_S real;
    real.bitc.data = m_uart2_thr.bitc.data;
    *(volatile U32 *)REG_UART2_THR_REAL = real.all;
}
...
{
    GH_UART2_DLL_REAL_S real;
    GH_UART2_DLL_S dummy;
    dummy.all = data ;
    real.bitc.bauddivint_l = dummy.bitc.bauddivint_l;
    *(volatile U32 *)REG_UART2_DLL_REAL = real.all;
}
GH_INLINE U32  GH_UART2_get_DLL(void)
{
    ...
    GH_UART2_DLL_S dummy;
     dummy.all =  0;
     real.all = (*(volatile U32 *)REG_UART2_DLL_REAL);
...
{
    GH_UART2_DLL_REAL_S d;
    d.all = *(volatile U32 *)REG_UART2_DLL_REAL;
    d.bitc.bauddivint_l = data;
    *(volatile U32 *)REG_UART2_DLL_REAL = d.all;
}
GH_INLINE U8   GH_UART2_get_DLL_BaudDivint_L(void)
{
    GH_UART2_DLL_REAL_S tmp_value;
    U32 value = (*(volatile U32 *)REG_UART2_DLL_REAL);
...
{
    GH_UART2_IER_REAL_S real;
    GH_UART2_IER_S dummy;
    dummy.all = data ;
    ...
    *(volatile U32 *)REG_UART2_IER_REAL = real.all;
}
GH_INLINE U32  GH_UART2_get_IER(void)
{
    ...
    GH_UART2_IER_S dummy;
     dummy.all =  0;
     real.all = (*(volatile U32 *)REG_UART2_IER_REAL);
...
{
    GH_UART2_IER_REAL_S d;
    d.all = *(volatile U32 *)REG_UART2_IER_REAL;
    d.bitc.erbfi = data;
    *(volatile U32 *)REG_UART2_IER_REAL = d.all;
}
GH_INLINE U8   GH_UART2_get_IER_erbfi(void)
{
    GH_UART2_IER_REAL_S tmp_value;
    U32 value = (*(volatile U32 *)REG_UART2_IER_REAL);
...
{
    GH_UART2_DLH_REAL_S real;
    GH_UART2_DLH_S dummy;
    dummy.all = data ;
    real.bitc.bauddivint_h = dummy.bitc.bauddivint_h;
    *(volatile U32 *)REG_UART2_DLH_REAL = real.all;
}
GH_INLINE U32  GH_UART2_get_DLH(void)
{
    ...
    GH_UART2_DLH_S dummy;
     dummy.all =  0;
     real.all = (*(volatile U32 *)REG_UART2_DLH_REAL);
...
{
    GH_UART2_DLH_REAL_S d;
    d.all = *(volatile U32 *)REG_UART2_DLH_REAL;
    d.bitc.bauddivint_h = data;
    *(volatile U32 *)REG_UART2_DLH_REAL = d.all;
}
GH_INLINE U8   GH_UART2_get_DLH_BaudDivint_H(void)
{
    GH_UART2_DLH_REAL_S tmp_value;
    U32 value = (*(volatile U32 *)REG_UART2_DLH_REAL);
...
{
    GH_UART2_IIR_REAL_S real;
    GH_UART2_IIR_S dummy;
     dummy.all =  0;
     real.all = (*(volatile U32 *)REG_UART2_IIR_REAL);
...
{
    GH_UART2_IIR_REAL_S tmp_value;
    U32 value = (*(volatile U32 *)REG_UART2_IIR_REAL);
...
GH_INLINE void GH_UART2_set_FCR(U32 data)
{
    ...
    GH_UART2_FCR_REAL_S real;
    GH_UART2_FCR_S dummy;
    dummy.all = data ;
    ...
    *(volatile U32 *)REG_UART2_FCR_REAL = real.all;
}
...
GH_INLINE void GH_UART2_set_FCR_FIFO_Enable(U8 data)
{
    ...
    GH_UART2_FCR_REAL_S real;
    real.bitc.fifo_enable = m_uart2_fcr.bitc.fifo_enable;
    real.bitc.rcvr_fifo_reset = m_uart2_fcr.bitc.rcvr_fifo_reset;
    real.bitc.xmit_fifo_reset = m_uart2_fcr.bitc.xmit_fifo_reset;
    real.bitc.dma_mode = m_uart2_fcr.bitc.dma_mode;
    real.bitc.tx_empty_trigger = m_uart2_fcr.bitc.tx_empty_trigger;
    real.bitc.rcvr_trigger = m_uart2_fcr.bitc.rcvr_trigger;
    *(volatile U32 *)REG_UART2_FCR_REAL = real.all;
}
...
{
    GH_UART2_LCR_REAL_S real;
    GH_UART2_LCR_S dummy;
    dummy.all = data ;
    ...
    *(volatile U32 *)REG_UART2_LCR_REAL = real.all;
}
GH_INLINE U32  GH_UART2_get_LCR(void)
{
    ...
    GH_UART2_LCR_S dummy;
     dummy.all =  0;
     real.all = (*(volatile U32 *)REG_UART2_LCR_REAL);
...
{
    GH_UART2_LCR_REAL_S d;
    d.all = *(volatile U32 *)REG_UART2_LCR_REAL;
    d.bitc.cls = data;
    *(volatile U32 *)REG_UART2_LCR_REAL = d.all;
}
GH_INLINE U8   GH_UART2_get_LCR_cls(void)
{
    GH_UART2_LCR_REAL_S tmp_value;
    U32 value = (*(volatile U32 *)REG_UART2_LCR_REAL);
...
{
    GH_UART2_MCR_REAL_S real;
    GH_UART2_MCR_S dummy;
    dummy.all = data ;
    ...
    *(volatile U32 *)REG_UART2_MCR_REAL = real.all;
}
GH_INLINE U32  GH_UART2_get_MCR(void)
{
    ...
    GH_UART2_MCR_S dummy;
     dummy.all =  0;
     real.all = (*(volatile U32 *)REG_UART2_MCR_REAL);
...
{
    GH_UART2_MCR_REAL_S d;
    d.all = *(volatile U32 *)REG_UART2_MCR_REAL;
    d.bitc.dtr = data;
    *(volatile U32 *)REG_UART2_MCR_REAL = d.all;
}
GH_INLINE U8   GH_UART2_get_MCR_dtr(void)
{
    GH_UART2_MCR_REAL_S tmp_value;
    U32 value = (*(volatile U32 *)REG_UART2_MCR_REAL);
...
{
    GH_UART2_LSR_REAL_S real;
    GH_UART2_LSR_S dummy;
     dummy.all =  0;
     real.all = (*(volatile U32 *)REG_UART2_LSR_REAL);
...
{
    GH_UART2_LSR_REAL_S tmp_value;
    U32 value = (*(volatile U32 *)REG_UART2_LSR_REAL);
...
{
    GH_UART2_MSR_REAL_S real;
    GH_UART2_MSR_S dummy;
     dummy.all =  0;
     real.all = (*(volatile U32 *)REG_UART2_MSR_REAL);
...
{
    GH_UART2_MSR_REAL_S tmp_value;
    U32 value = (*(volatile U32 *)REG_UART2_MSR_REAL);
...
{
    GH_UART2_SCR_REAL_S real;
    GH_UART2_SCR_S dummy;
    dummy.all = data ;
    real.bitc.scr = dummy.bitc.scr;
    *(volatile U32 *)REG_UART2_SCR_REAL = real.all;
}
GH_INLINE U32  GH_UART2_get_SCR(void)
{
    ...
    GH_UART2_SCR_S dummy;
     dummy.all =  0;
     real.all = (*(volatile U32 *)REG_UART2_SCR_REAL);
...
{
    GH_UART2_SCR_REAL_S d;
    d.all = *(volatile U32 *)REG_UART2_SCR_REAL;
    d.bitc.scr = data;
    *(volatile U32 *)REG_UART2_SCR_REAL = d.all;
}
GH_INLINE U8   GH_UART2_get_SCR_scr(void)
{
    GH_UART2_SCR_REAL_S tmp_value;
    U32 value = (*(volatile U32 *)REG_UART2_SCR_REAL);
...
/* init function                                                              */
/*----------------------------------------------------------------------------*/
GH_INLINE void GH_UART2_init(void)
{
    GH_UART2_set_THR((U32)0x00000000);
    GH_UART2_set_DLL((U32)0x00000000);
    GH_UART2_set_IER((U32)0x00000000);
    GH_UART2_set_DLH((U32)0x00000000);
    GH_UART2_set_FCR((U32)0x00000000);
    GH_UART2_set_LCR((U32)0x00000000);
    GH_UART2_set_MCR((U32)0x00000000);
    GH_UART2_set_SCR((U32)0x00000000);
