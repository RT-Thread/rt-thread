...
#define __sdram_zero_nocache$$Base            Image$$__sdram_zero_nocache$$ZI$$Base
#define __sdram_zero_nocache$$Limit           Image$$__sdram_zero_nocache$$ZI$$Limit
#define __sdram_zero$$Base                    Image$$__sdram_zero$$ZI$$Base
#define __sdram_zero$$Limit                   Image$$__sdram_zero$$ZI$$Limit
#define __ospi0_cs0_zero_nocache$$Base        Image$$__ospi0_cs0_zero_nocache$$ZI$$Base
#define __ospi0_cs0_zero_nocache$$Limit       Image$$__ospi0_cs0_zero_nocache$$ZI$$Limit
#define __ospi0_cs0_zero$$Base                Image$$__ospi0_cs0_zero$$ZI$$Base
#define __ospi0_cs0_zero$$Limit               Image$$__ospi0_cs0_zero$$ZI$$Limit
#define __ospi1_cs0_zero_nocache$$Base        Image$$__ospi1_cs0_zero_nocache$$ZI$$Base
#define __ospi1_cs0_zero_nocache$$Limit       Image$$__ospi1_cs0_zero_nocache$$ZI$$Limit
#define __ospi1_cs0_zero$$Base                Image$$__ospi1_cs0_zero$$ZI$$Base
#define __ospi1_cs0_zero$$Limit               Image$$__ospi1_cs0_zero$$ZI$$Limit
#define __ctcm_zero$$Base                     Image$$__ctcm_zero$$ZI$$Base
#define __ctcm_zero$$Limit                    Image$$__ctcm_zero$$ZI$$Limit
#define __stcm_zero$$Base                     Image$$__stcm_zero$$ZI$$Base
#define __stcm_zero$$Limit                    Image$$__stcm_zero$$ZI$$Limit
#define __ram_zero_nocache$$Base              Image$$__ram_zero_nocache$$ZI$$Base
#define __ram_zero_nocache$$Limit             Image$$__ram_zero_nocache$$ZI$$Limit
#define __ram_zero$$Base                      Image$$__ram_zero$$ZI$$Base
#define __ram_zero$$Limit                     Image$$__ram_zero$$ZI$$Limit
#define __sdram_from_ospi0_cs1$$Base          Image$$__sdram_from_ospi0_cs1$$Base
#define __sdram_from_ospi0_cs1$$Limit         Image$$__sdram_from_ospi0_cs1$$Limit
#define __sdram_from_ospi1_cs1$$Base          Image$$__sdram_from_ospi1_cs1$$Base
#define __sdram_from_ospi1_cs1$$Limit         Image$$__sdram_from_ospi1_cs1$$Limit
#define __sdram_from_data_flash$$Base         Image$$__sdram_from_data_flash$$Base
#define __sdram_from_data_flash$$Limit        Image$$__sdram_from_data_flash$$Limit
#define __sdram_from_flash$$Base              Image$$__sdram_from_flash$$Base
#define __sdram_from_flash$$Limit             Image$$__sdram_from_flash$$Limit
#define __ospi0_cs0_from_ospi0_cs1$$Base      Image$$__ospi0_cs0_from_ospi0_cs1$$Base
#define __ospi0_cs0_from_ospi0_cs1$$Limit     Image$$__ospi0_cs0_from_ospi0_cs1$$Limit
#define __ospi0_cs0_from_ospi1_cs1$$Base      Image$$__ospi0_cs0_from_ospi1_cs1$$Base
#define __ospi0_cs0_from_ospi1_cs1$$Limit     Image$$__ospi0_cs0_from_ospi1_cs1$$Limit
#define __ospi0_cs0_from_data_flash$$Base     Image$$__ospi0_cs0_from_data_flash$$Base
#define __ospi0_cs0_from_data_flash$$Limit    Image$$__ospi0_cs0_from_data_flash$$Limit
#define __ospi0_cs0_from_flash$$Base          Image$$__ospi0_cs0_from_flash$$Base
#define __ospi0_cs0_from_flash$$Limit         Image$$__ospi0_cs0_from_flash$$Limit
#define __ospi1_cs0_from_ospi0_cs1$$Base      Image$$__ospi1_cs0_from_ospi0_cs1$$Base
#define __ospi1_cs0_from_ospi0_cs1$$Limit     Image$$__ospi1_cs0_from_ospi0_cs1$$Limit
#define __ospi1_cs0_from_ospi1_cs1$$Base      Image$$__ospi1_cs0_from_ospi1_cs1$$Base
#define __ospi1_cs0_from_ospi1_cs1$$Limit     Image$$__ospi1_cs0_from_ospi1_cs1$$Limit
#define __ospi1_cs0_from_data_flash$$Base     Image$$__ospi1_cs0_from_data_flash$$Base
#define __ospi1_cs0_from_data_flash$$Limit    Image$$__ospi1_cs0_from_data_flash$$Limit
#define __ospi1_cs0_from_flash$$Base          Image$$__ospi1_cs0_from_flash$$Base
#define __ospi1_cs0_from_flash$$Limit         Image$$__ospi1_cs0_from_flash$$Limit
#define __ctcm_from_ospi0_cs1$$Base           Image$$__ctcm_from_ospi0_cs1$$Base
#define __ctcm_from_ospi0_cs1$$Limit          Image$$__ctcm_from_ospi0_cs1$$Limit
#define __ctcm_from_ospi1_cs1$$Base           Image$$__ctcm_from_ospi1_cs1$$Base
#define __ctcm_from_ospi1_cs1$$Limit          Image$$__ctcm_from_ospi1_cs1$$Limit
#define __ctcm_from_data_flash$$Base          Image$$__ctcm_from_data_flash$$Base
#define __ctcm_from_data_flash$$Limit         Image$$__ctcm_from_data_flash$$Limit
#define __ctcm_from_flash$$Base               Image$$__ctcm_from_flash$$Base
#define __ctcm_from_flash$$Limit              Image$$__ctcm_from_flash$$Limit
#define __stcm_from_ospi0_cs1$$Base           Image$$__stcm_from_ospi0_cs1$$Base
#define __stcm_from_ospi0_cs1$$Limit          Image$$__stcm_from_ospi0_cs1$$Limit
#define __stcm_from_ospi1_cs1$$Base           Image$$__stcm_from_ospi1_cs1$$Base
#define __stcm_from_ospi1_cs1$$Limit          Image$$__stcm_from_ospi1_cs1$$Limit
#define __stcm_from_data_flash$$Base          Image$$__stcm_from_data_flash$$Base
#define __stcm_from_data_flash$$Limit         Image$$__stcm_from_data_flash$$Limit
#define __stcm_from_flash$$Base               Image$$__stcm_from_flash$$Base
#define __stcm_from_flash$$Limit              Image$$__stcm_from_flash$$Limit
#define __ram_from_ospi0_cs1$$Base            Image$$__ram_from_ospi0_cs1$$Base
#define __ram_from_ospi0_cs1$$Limit           Image$$__ram_from_ospi0_cs1$$Limit
#define __ram_from_ospi1_cs1$$Base            Image$$__ram_from_ospi1_cs1$$Base
#define __ram_from_ospi1_cs1$$Limit           Image$$__ram_from_ospi1_cs1$$Limit
#define __ram_from_data_flash$$Base           Image$$__ram_from_data_flash$$Base
#define __ram_from_data_flash$$Limit          Image$$__ram_from_data_flash$$Limit
#define __ram_from_flash$$Base                Image$$__ram_from_flash$$Base
#define __ram_from_flash$$Limit               Image$$__ram_from_flash$$Limit
#define __sdram_noinit_nocache$$Base          Image$$__sdram_noinit_nocache$$ZI$$Base
#define __sdram_noinit_nocache$$Limit         Image$$__sdram_noinit_nocache$$ZI$$Limit
#define __ospi0_cs0_noinit_nocache$$Base      Image$$__ospi0_cs0_noinit_nocache$$ZI$$Base
#define __ospi0_cs0_noinit_nocache$$Limit     Image$$__ospi0_cs0_noinit_nocache$$ZI$$Limit
#define __ospi1_cs0_noinit_nocache$$Base      Image$$__ospi1_cs0_noinit_nocache$$ZI$$Base
#define __ospi1_cs0_noinit_nocache$$Limit     Image$$__ospi1_cs0_noinit_nocache$$ZI$$Limit
#define __ram_noinit_nocache$$Base            Image$$__ram_noinit_nocache$$ZI$$Base
#define __ram_noinit_nocache$$Limit           Image$$__ram_noinit_nocache$$ZI$$Limit
...
#define __ctcm_from_ospi0_cs1$$Load           Load$$__ctcm_from_ospi0_cs1$$Base
#define __ctcm_from_ospi1_cs1$$Load           Load$$__ctcm_from_ospi1_cs1$$Base
#define __ctcm_from_data_flash$$Load          Load$$__ctcm_from_data_flash$$Base
#define __ctcm_from_flash$$Load               Load$$__ctcm_from_flash$$Base
#define __stcm_from_ospi0_cs1$$Load           Load$$__stcm_from_ospi0_cs1$$Base
#define __stcm_from_ospi1_cs1$$Load           Load$$__stcm_from_ospi1_cs1$$Base
#define __stcm_from_data_flash$$Load          Load$$__stcm_from_data_flash$$Base
#define __stcm_from_flash$$Load               Load$$__stcm_from_flash$$Base
