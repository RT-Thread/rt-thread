...
typedef enum
{
  USER_USER_USB_STATE_UNCONNECTED   = 0,
  USER_USER_USB_STATE_ATTACHED      = 1,
  USER_USER_USB_STATE_POWERED       = 2,
  USER_USER_USB_STATE_SUSPENDED     = 3,
  USER_USER_USB_STATE_DEFAULT       = 4,
  USER_USER_USB_STATE_ADDRESS       = 5,
  USER_USER_USB_STATE_CONFIGURED    = 6,
