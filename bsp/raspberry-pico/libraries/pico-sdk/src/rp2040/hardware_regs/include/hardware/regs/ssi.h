...
//                  * APB interface 每 Allows for easy integration into a
//                  DesignWare Synthesizable Components for AMBA 2
//                  implementation.
//                  * APB3 and APB4 protocol support.
//                  * Scalable APB data bus width 每 Supports APB data bus widths
//                  of 8, 16, and 32 bits.
//                  * Serial-master or serial-slave operation 每 Enables serial
...
//                  * DMA Controller Interface 每 Enables the DW_apb_ssi to
//                  interface to a DMA controller over the bus using a
//                  handshaking interface for transfer requests.
//                  * Independent masking of interrupts 每 Master collision,
...
//                  * Multi-master contention detection 每 Informs the processor
//                  of multiple serial-master accesses on the serial bus.
//                  * Bypass of meta-stability flip-flops for synchronous clocks
//                  每 When the APB clock (pclk) and the DW_apb_ssi serial clock
...
//                  - Serial interface operation 每 Choice of Motorola SPI, Texas
//                  Instruments Synchronous Serial Protocol or National
//                  Semiconductor Microwire.
//                  - Clock bit-rate 每 Dynamic control of the serial bit rate of
//                  the data transfer; used in only serial-master mode of
//                  operation.
//                  - Data Item size (4 to 32 bits) 每 Item size of each data
//                  transfer under the control of the programmer.
//                  * Configured features:
//                  - FIFO depth 每 16 words deep. The FIFO width is fixed at 32
//                  bits.
//                  - 1 slave select output.
//                  - Hardware slave-select 每 Dedicated hardware slave-select
//                  line.
//                  - Combined interrupt line - one combined interrupt line from
//                  the DW_apb_ssi to the interrupt controller.
//                  - Interrupt polarity 每 active high interrupt lines.
//                  - Serial clock polarity 每 low serial-clock polarity directly
//                  after reset.
//                  - Serial clock phase 每 capture on first edge of serial-clock
