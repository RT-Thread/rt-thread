 ...
 * Change Logs:
 * Date           Author       Notes
 * 2026-04-21     wdfk-prog    add stm32wb adc v2 configuration
 */

/**
 * @file adc_config_v2.h
 * @brief STM32WB ADC V2 configuration defaults.
 */
...
/** @brief Default ADC clock prescaler for STM32WB. */
...
/** @brief Default ADC data alignment for STM32WB. */
...
/** @brief Default ADC sampling time for STM32WB. */
#if defined(ADC_SAMPLETIME_2CYCLES_5)
#define ADC_DEFAULT_SAMPLING_TIME ADC_SAMPLETIME_2CYCLES_5
#else
#define ADC_DEFAULT_SAMPLING_TIME 0U
#endif /* defined(ADC_SAMPLETIME_2CYCLES_5) */


/** @brief Maximum regular sequence length supported by the STM32WB driver. */
...
/** @brief Default STM32WB ADC1 V2 object initializer. */
...
/** @brief Default STM32WB ADC2 V2 object initializer. */
...
/** @brief Default STM32WB ADC3 V2 object initializer. */
