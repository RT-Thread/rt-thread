...
void GH_SDIO1_init(void)
{
    ...
    GH_SDIO1_set_TranModeNorIntSigEnReg((U32)0x00000000);
    GH_SDIO1_set_ErrIntSigEnBlkCouReg((U32)0x00000000);
    GH_SDIO1_set_BlkSizeNorIntStaEnReg((U32)0x00000000);
    GH_SDIO1_set_ErrIntStaEnNorIntStaReg((U32)0x00000000);
    GH_SDIO1_set_ErrIntStatusCommondReg((U32)0x00000000);
    GH_SDIO1_set_Control01Reg((U32)0x00000000);
