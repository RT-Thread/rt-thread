 ...
 * 2019-07-21     Zhou Yanjie  clean up code
 */
...
{
	16,		/* icache_line_size */
	256,	/* icache_sets_per_way */
	4,		/* icache_ways */
	16,		/* dcache_line_size */
	256,	/* dcache_sets_per_way */
	4,		/* dcache_ways */
	16,		/* max_tlb_entries */
};
...
void mips32_cfg_init(void)
{
	...
	if (cp0_config1 & 0x80000000)
	{
		...
		g_mips_core.icache_sets_per_way = 64 * m_pow(2, val);
		...
		g_mips_core.dcache_sets_per_way = 64 * m_pow(2, val);
