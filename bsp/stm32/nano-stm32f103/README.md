# Nano STM32F103C8 Blue Pill Board BSP Introduction

 [[中文]](README_zh.md)

[TOC]

This BSP is a minimum (nano) configuration description based on the STM32F103C8T6 minimum system board (BluePill). This BSP only enables basic kernel functions by default, and turns off the device framework and msh components.
