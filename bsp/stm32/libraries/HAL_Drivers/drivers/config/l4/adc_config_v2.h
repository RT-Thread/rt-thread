 ...
 * Change Logs:
 * Date           Author       Notes
 * 2026-04-21     wdfk-prog    add stm32l4 adc v2 configuration
 */

/**
 * @file adc_config_v2.h
 * @brief STM32L4 ADC V2 configuration defaults.
 */
...
/** @brief Default ADC clock prescaler for STM32L4. */
...
/** @brief Default ADC data alignment for STM32L4. */
...
/** @brief Default ADC sampling time for STM32L4. */
...
/** @brief Maximum regular sequence length supported by the STM32L4 driver. */
...
/** @brief STM32L4 temperature sensor HAL ADC channel for the multi-instance route. */
#define STM32_ADC_TEMP_HAL_CHANNEL ADC_CHANNEL_TEMPSENSOR
/** @brief STM32L4 ADC instances that can sample temperature sensor. */
#define STM32_ADC_TEMP_INSTANCE_MASK ((1UL << 0) | (1UL << 2))
#endif /* defined(ADC_CHANNEL_TEMPSENSOR) */

#if defined(ADC_CHANNEL_VBAT)
/** @brief STM32L4 VBAT HAL ADC channel for the multi-instance route. */
#define STM32_ADC_VBAT_HAL_CHANNEL ADC_CHANNEL_VBAT
/** @brief STM32L4 ADC instances that can sample VBAT. */
#define STM32_ADC_VBAT_INSTANCE_MASK ((1UL << 0) | (1UL << 2))
#endif /* defined(ADC_CHANNEL_VBAT) */

#if defined(ADC_CHANNEL_VREFINT)
/** @brief STM32L4 VREFINT HAL ADC channel for the multi-instance route. */
#define STM32_ADC_VREF_HAL_CHANNEL ADC_CHANNEL_VREFINT
/** @brief STM32L4 ADC instances that can sample VREFINT. */
#define STM32_ADC_VREF_INSTANCE_MASK ((1UL << 0) | (1UL << 1) | (1UL << 2))
...
/** @brief Default STM32L4 ADC1 V2 object initializer. */
...
/** @brief Default STM32L4 ADC2 V2 object initializer. */
...
/** @brief Default STM32L4 ADC3 V2 object initializer. */
