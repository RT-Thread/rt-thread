...
static VPOST_T DEF_E50A2V1 = {  800,                            /*!< Panel width */
                                ...
                                0,                              /*!< MPU mode */
                                VPOSTB_COLORTYPE_64K,// VPOSTB_COLORTYPE_16M,           /*!< Display colors */
...
void vpostLCMInit(uint32_t u32DisplayPanelID)
{
    ...
    rt_hw_interrupt_install(LCD_IRQn, (rt_isr_handler_t)vpostIntHandler, NULL, "LCD_IRQ");
