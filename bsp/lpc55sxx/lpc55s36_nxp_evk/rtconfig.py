...
if PLATFORM == 'gcc':
    ...
    AFLAGS = DEVICE
    LFLAGS = DEVICE + ' --libpath "' + EXEC_PATH + '/ARM/ARMCC/lib" --info sizes --info totals --info unused --info veneers --list rtthread.map --scatter "./LPC55S36_flash.scf" '
    ...
    LFLAGS = ' --config "board/linker_scripts/LPC55S36_flash.icf"'
