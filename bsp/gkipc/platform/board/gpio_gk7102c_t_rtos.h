#ifndef GPIO_CFG_GK7101CT_V1_H
#define GPIO_CFG_GK7101CT_V1_H
#include "adi_types.h"
#include "adi_gpio.h"
...
#define SYSTEM_GPIO_XREF_TABLE                            \
    ...
    { GADI_GPIO_2 , GADI_GPIO_TYPE_INOUT_I2C_DATA                      }, \
    { GADI_GPIO_3 , GADI_GPIO_TYPE_INOUT_I2C_CLK                       }, \
    { GADI_GPIO_4 , GADI_GPIO_TYPE_INOUT_I2C_CLK2                      }, \
    { GADI_GPIO_5 , GADI_GPIO_TYPE_INOUT_I2C_DATA2                      }, \
    ...
    { GADI_GPIO_14, GADI_GPIO_TYPE_UNDEFINED/* IR_CUT+*/     		      }, \
    { GADI_GPIO_15, GADI_GPIO_TYPE_UNDEFINED             		   }, \
    { GADI_GPIO_16, GADI_GPIO_TYPE_UNDEFINED                	  }, \
    { GADI_GPIO_17,  GADI_GPIO_TYPE_UNDEFINED/*IR_CUT-*/   			  }, \
    ...
    { GADI_GPIO_31, GADI_GPIO_TYPE_INPUT_0                        /*sensor data*/}, \
    { GADI_GPIO_32, GADI_GPIO_TYPE_INPUT_0                        /*sensor data*/}, \
...
#define SYSTEM_GPIO_IR_CUT1         GADI_GPIO_14
#define SYSTEM_GPIO_IR_CUT2         GADI_GPIO_17
