...
typedef struct {
    ...
    __RW uint32_t UVW_POS_CFG[6];              /* 0x258 - 0x26C:  */
 ...
 * RD_SEL (RW)
 *
 * define the width/counter value(affect width_match, width_match2, width_cur, timer_cur, width_read, timer_read, width_snap0,width_snap1, timer_snap0, timer_snap1)
