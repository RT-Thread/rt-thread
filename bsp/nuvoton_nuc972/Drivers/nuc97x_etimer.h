...
/**
  ...
  * \hideinitializer
  */
rt_inline int ETIMER_Is_Active(UINT timer)
{
    int reg;
...
/**
  ...
  * @return None
  */
rt_inline void ETIMER_Start(UINT timer)
{
    if (timer == 0)
    {
...
/**
  ...
  * @return None
  */
rt_inline void ETIMER_Stop(UINT timer)
{
    if (timer == 0)
    {
        outpw(REG_ETMR0_CTL, inpw(REG_ETMR0_CTL) & ~1);
...
/**
  ...
  */
rt_inline void ETIMER_EnableWakeup(UINT timer)
{
    if (timer == 0)
    {
...
/**
  ...
  * @return None
  */
rt_inline void ETIMER_DisableWakeup(UINT timer)
{
    if (timer == 0)
    {
        outpw(REG_ETMR0_CTL, inpw(REG_ETMR0_CTL) & ~4);
...
/**
  ...
  * @return None
  */
rt_inline void ETIMER_EnableCaptureDebounce(UINT timer)
{
    if (timer == 0)
    {
...
/**
  ...
  * @return None
  */
rt_inline void ETIMER_DisableCaptureDebounce(UINT timer)
{
    if (timer == 0)
    {
        outpw(REG_ETMR0_CTL, inpw(REG_ETMR0_CTL) & ~0x400000);
...
/**
  ...
  * @return None
  */
rt_inline void ETIMER_EnableInt(UINT timer)
{
    if (timer == 0)
    {
...
/**
  ...
  * @return None
  */
rt_inline void ETIMER_DisableInt(UINT timer)
{
    if (timer == 0)
    {
        outpw(REG_ETMR0_IER, inpw(REG_ETMR0_IER) & ~1);
...
/**
  ...
  * @return None
  */
rt_inline void ETIMER_EnableCaptureInt(UINT timer)
{
    if (timer == 0)
    {
...
/**
  ...
  * @return None
  */
rt_inline void ETIMER_DisableCaptureInt(UINT timer)
{
    if (timer == 0)
    {
        outpw(REG_ETMR0_IER, inpw(REG_ETMR0_IER) & ~2);
...
/**
  ...
  */
rt_inline UINT ETIMER_GetIntFlag(UINT timer)
{
    int reg;
...
/**
  ...
  * @return None
  */
rt_inline void ETIMER_ClearIntFlag(UINT timer)
{
    if (timer == 0)
    {
...
/**
  ...
  */
rt_inline UINT ETIMER_GetCaptureIntFlag(UINT timer)
{
    int reg;
...
/**
  ...
  * @return None
  */
rt_inline void ETIMER_ClearCaptureIntFlag(UINT timer)
{
    if (timer == 0)
    {
...
/**
  ...
  */
rt_inline UINT ETIMER_GetWakeupFlag(UINT timer)
{
    int reg;
...
/**
  ...
  * @return None
  */
rt_inline void ETIMER_ClearWakeupFlag(UINT timer)
{
    if (timer == 0)
    {
...
/**
  ...
  */
rt_inline UINT ETIMER_GetCaptureData(UINT timer)
{
    if (timer == 0)
    {
...
/**
  ...
  */
rt_inline UINT ETIMER_GetCounter(UINT timer)
{
    if (timer == 0)
    {
