...
#define N32H49X_DAC_CONFIG(DAC_INSTANCE)                              \
    {                                                                 \
        .DACx = DAC_INSTANCE,                                         \
        .DAC_Module = DAC12,                                          \
        .periph_clk = RCC_APB1_PERIPHEN_DAC12,                        \
...
#ifndef DAC1_CONFIG
#define DAC1_CONFIG N32H49X_DAC_CONFIG(DAC1)
#endif /* DAC1_CONFIG */
#endif /* BSP_USING_DAC1 */

#ifdef BSP_USING_DAC2
#ifndef DAC2_CONFIG
#define DAC2_CONFIG N32H49X_DAC_CONFIG(DAC2)
#endif /* DAC2_CONFIG */
